...
##############################################################################
class aall_operator_b(unittest.TestCase):
	...
	def setUp(self):
		"""Initialise.
		"""
		self.data = array.array('b', [100]*10)
	...
	def test_operator_01_eq(self):
		...
		result = arrayfunc.aall(arrayfunc.aops.af_eq, self.data, 99)
	...
	def test_operator_02_gt(self):
		...
		"""
		result = arrayfunc.aall(arrayfunc.aops.af_gt, self.data, 99)
		self.assertTrue(result)
		result = arrayfunc.aall(arrayfunc.aops.af_gt, self.data, 100)
		self.assertFalse(result)
	...
	def test_operator_03_gte(self):
		...
		"""
		result = arrayfunc.aall(arrayfunc.aops.af_gte, self.data, 99)
		self.assertTrue(result)
		result = arrayfunc.aall(arrayfunc.aops.af_gte, self.data, 100)
		self.assertTrue(result)
		result = arrayfunc.aall(arrayfunc.aops.af_gte, self.data, 101)
		self.assertFalse(result)
	...
	def test_operator_04_lt(self):
		...
		"""
		result = arrayfunc.aall(arrayfunc.aops.af_lt, self.data, 101)
		self.assertTrue(result)
		result = arrayfunc.aall(arrayfunc.aops.af_lt, self.data, 100)
		self.assertFalse(result)
	...
	def test_operator_05_lte(self):
		...
		"""
		result = arrayfunc.aall(arrayfunc.aops.af_lte, self.data, 101)
		self.assertTrue(result)
		result = arrayfunc.aall(arrayfunc.aops.af_lte, self.data, 100)
		self.assertTrue(result)
		result = arrayfunc.aall(arrayfunc.aops.af_lte, self.data, 99)
		self.assertFalse(result)
	...
	def test_operator_06_ne(self):
		...
		"""
		result = arrayfunc.aall(arrayfunc.aops.af_ne, self.data, 99)
		self.assertTrue(result)
		result = arrayfunc.aall(arrayfunc.aops.af_ne, self.data, 100)
		self.assertFalse(result)
...
##############################################################################
class aall_operator_h(unittest.TestCase):
	"""Test for basic operator function.
	"""
	...
	def setUp(self):
		"""Initialise.
		"""
		self.data = array.array('h', [100]*10)
...
##############################################################################
class aall_operator_i(unittest.TestCase):
	"""Test for basic operator function.
	"""
	...
	def setUp(self):
		"""Initialise.
		"""
		self.data = array.array('i', [100]*10)
...
##############################################################################
class aall_operator_l(unittest.TestCase):
	"""Test for basic operator function.
	"""
	...
	def setUp(self):
		"""Initialise.
		"""
		self.data = array.array('l', [100]*10)
...
class aall_operator_q(unittest.TestCase):
	"""Test for basic operator function.
	"""
	...
	def setUp(self):
		"""Initialise.
		"""
		self.data = array.array('q', [100]*10)
...
##############################################################################
class aall_operator_f(unittest.TestCase):
	"""Test for basic operator function.
	"""
	...
	def test_operator_01_eq(self):
		...
		"""
		result = arrayfunc.aall(arrayfunc.aops.af_eq, self.data, 100.0)
		self.assertTrue(result)
		result = arrayfunc.aall(arrayfunc.aops.af_eq, self.data, 99.0)
		self.assertFalse(result)
	...
	def test_operator_02_gt(self):
		...
		"""
		result = arrayfunc.aall(arrayfunc.aops.af_gt, self.data, 99.0)
		self.assertTrue(result)
		result = arrayfunc.aall(arrayfunc.aops.af_gt, self.data, 100.0)
		self.assertFalse(result)
	...
	def test_operator_03_gte(self):
		...
		"""
		result = arrayfunc.aall(arrayfunc.aops.af_gte, self.data, 99.0)
		self.assertTrue(result)
		result = arrayfunc.aall(arrayfunc.aops.af_gte, self.data, 100.0)
		self.assertTrue(result)
		result = arrayfunc.aall(arrayfunc.aops.af_gte, self.data, 101.0)
		self.assertFalse(result)
	...
	def test_operator_04_lt(self):
		...
		"""
		result = arrayfunc.aall(arrayfunc.aops.af_lt, self.data, 101.0)
		self.assertTrue(result)
		result = arrayfunc.aall(arrayfunc.aops.af_lt, self.data, 100.0)
		self.assertFalse(result)
	...
	def test_operator_05_lte(self):
		...
		"""
		result = arrayfunc.aall(arrayfunc.aops.af_lte, self.data, 101.0)
		self.assertTrue(result)
		result = arrayfunc.aall(arrayfunc.aops.af_lte, self.data, 100.0)
		self.assertTrue(result)
		result = arrayfunc.aall(arrayfunc.aops.af_lte, self.data, 99.0)
		self.assertFalse(result)
	...
	def test_operator_06_ne(self):
		...
		"""
		result = arrayfunc.aall(arrayfunc.aops.af_ne, self.data, 99.0)
		self.assertTrue(result)
		result = arrayfunc.aall(arrayfunc.aops.af_ne, self.data, 100.0)
		self.assertFalse(result)
...
##############################################################################
class aall_operator_d(unittest.TestCase):
	"""Test for basic operator function.
	"""
...
class aall_parameter_b(unittest.TestCase):
	...
	def test_param_04_five_params(self):
		"""Test exception when five parameters passed  - Array code b.
		"""
		with self.assertRaises(TypeError):
			result = arrayfunc.aall(arrayfunc.aops.af_eq, self.data, 100, 99, 99)
...
class aall_parameter_h(unittest.TestCase):
	...
	########################################################
	def test_param_04_five_params(self):
		"""Test exception when five parameters passed  - Array code h.
		"""
		with self.assertRaises(TypeError):
			result = arrayfunc.aall(arrayfunc.aops.af_eq, self.data, 100, 99, 99)
...
class aall_parameter_i(unittest.TestCase):
	...
	########################################################
	def test_param_04_five_params(self):
		"""Test exception when five parameters passed  - Array code i.
		"""
		with self.assertRaises(TypeError):
			result = arrayfunc.aall(arrayfunc.aops.af_eq, self.data, 100, 99, 99)
...
class aall_parameter_l(unittest.TestCase):
	...
	########################################################
	def test_param_04_five_params(self):
		"""Test exception when five parameters passed  - Array code l.
		"""
		with self.assertRaises(TypeError):
			result = arrayfunc.aall(arrayfunc.aops.af_eq, self.data, 100, 99, 99)
...
class aall_parameter_q(unittest.TestCase):
	...
	########################################################
	def test_param_04_five_params(self):
		"""Test exception when five parameters passed  - Array code q.
		"""
		with self.assertRaises(TypeError):
			result = arrayfunc.aall(arrayfunc.aops.af_eq, self.data, 100, 99, 99)
...
class aall_parameter_f(unittest.TestCase):
	...
	########################################################
	def test_param_04_five_params(self):
		"""Test exception when five parameters passed  - Array code f.
		"""
		with self.assertRaises(TypeError):
			result = arrayfunc.aall(arrayfunc.aops.af_eq, self.data, 100.0, 99, 99)
...
class aall_parameter_d(unittest.TestCase):
	...
	########################################################
	def test_param_04_five_params(self):
		"""Test exception when five parameters passed  - Array code d.
		"""
		with self.assertRaises(TypeError):
			result = arrayfunc.aall(arrayfunc.aops.af_eq, self.data, 100.0, 99, 99)
...
##############################################################################
class aall_operator_bytes(unittest.TestCase):
	"""Test for basic operator function.
	"""
...
class aall_parameter_bytes(unittest.TestCase):
	...
	########################################################
	def test_param_04_five_params(self):
		"""Test exception when five parameters passed  - Array code bytes.
		"""
		with self.assertRaises(TypeError):
			result = arrayfunc.aall(arrayfunc.aops.af_eq, self.data, 100, 99, 99)

...
##############################################################################
class add_general_b(unittest.TestCase):
	...
	########################################################
	def test_add_basic_array_array_array_e5(self):
	...
	########################################################
	def test_add_basic_array_array_array_e6(self):
		"""Test add as *array-array-array* for basic function - Array code b.
		"""
		data1 = array.array('b', self.datax)
		data2 = array.array('b', self.datay)
	...
	########################################################
	def test_add_basic_array_array_array_e7(self):
		"""Test add as *array-array-array* for basic function - Array code b.
		"""
		data1 = array.array('b', self.datax)
		data2 = array.array('b', self.datay)
...
class add_opt_param_errors_b(unittest.TestCase):
	...
	########################################################
	def test_add_array_num_none_a1(self):
		"""Test add as *array-num-none* for errors='a' - Array code b.
		"""
		...
		# This is the actual test.
		with self.assertRaises(TypeError):
			arrayfunc.add(self.inparray1b, inpvalue, errors='a')
	...
	########################################################
	def test_add_array_num_array_b1(self):
		"""Test add as *array-num-array* for errors='a' - Array code b.
		"""
		inpvalue = self.inparray2a[0]
		...
		# This is the actual test.
		with self.assertRaises(TypeError):
			arrayfunc.add(self.inparray1b, inpvalue, self.dataout, errors='a')
	...
	########################################################
	def test_add_num_array_none_c1(self):
		"""Test add as *num-array-none* for errors='a' - Array code b.
		"""
		...
		# This is the actual test.
		with self.assertRaises(TypeError):
			arrayfunc.add(inpvalue, self.inparray2b, errors='a')
	...
	########################################################
	def test_add_num_array_array_d1(self):
		"""Test add as *num-array-array* for errors='a' - Array code b.
		"""
		inpvalue = self.inparray1a[0]
		...
		# This is the actual test.
		with self.assertRaises(TypeError):
			arrayfunc.add(inpvalue, self.inparray2b, self.dataout, errors='a')
	...
	########################################################
	def test_add_array_array_none_e1(self):
		"""Test add as *array-array-none* for errors='a' - Array code b.
		"""
		...
		# This is the actual test.
		with self.assertRaises(TypeError):
			arrayfunc.add(self.inparray1b, self.inparray2b, errors='a')
	...
	########################################################
	def test_add_array_array_array_f1(self):
		"""Test add as *array-array-array* for errors='a' - Array code b.
		"""
		# This version is expected to pass.
		...
		# This is the actual test.
		with self.assertRaises(TypeError):
			arrayfunc.add(self.inparray1b, self.inparray2b, self.dataout, errors='a')
...
##############################################################################
class add_general_h(unittest.TestCase):
	"""Test add for basic general function operation using numeric 
	data -25,-1,0,1,25.
	test_template_op
	"""
...
class add_opt_param_errors_h(unittest.TestCase):
	...
	########################################################
	def test_add_array_num_none_a1(self):
		"""Test add as *array-num-none* for errors='a' - Array code h.
		"""
		inpvalue = self.inparray2a[0]
	...
	########################################################
	def test_add_array_num_array_b1(self):
		"""Test add as *array-num-array* for errors='a' - Array code h.
		"""
		inpvalue = self.inparray2a[0]
	...
	########################################################
	def test_add_num_array_none_c1(self):
		"""Test add as *num-array-none* for errors='a' - Array code h.
		"""
		inpvalue = self.inparray1a[0]
	...
	########################################################
	def test_add_num_array_array_d1(self):
		"""Test add as *num-array-array* for errors='a' - Array code h.
		"""
		inpvalue = self.inparray1a[0]
	...
	########################################################
	def test_add_array_array_none_e1(self):
		"""Test add as *array-array-none* for errors='a' - Array code h.
		"""
	...
	########################################################
	def test_add_array_array_array_f1(self):
		"""Test add as *array-array-array* for errors='a' - Array code h.
		"""
		# This version is expected to pass.
		arrayfunc.add(self.inparray1a, self.inparray2a, self.dataout, matherrors=True)
...
##############################################################################
class add_general_i(unittest.TestCase):
	"""Test add for basic general function operation using numeric 
	data -25,-1,0,1,25.
	test_template_op
	"""
...
class add_opt_param_errors_i(unittest.TestCase):
	...
	########################################################
	def test_add_array_num_none_a1(self):
		"""Test add as *array-num-none* for errors='a' - Array code i.
		"""
		inpvalue = self.inparray2a[0]
	...
	########################################################
	def test_add_array_num_array_b1(self):
		"""Test add as *array-num-array* for errors='a' - Array code i.
		"""
		inpvalue = self.inparray2a[0]
	...
	########################################################
	def test_add_num_array_none_c1(self):
		"""Test add as *num-array-none* for errors='a' - Array code i.
		"""
		inpvalue = self.inparray1a[0]
	...
	########################################################
	def test_add_num_array_array_d1(self):
		"""Test add as *num-array-array* for errors='a' - Array code i.
		"""
		inpvalue = self.inparray1a[0]
	...
	########################################################
	def test_add_array_array_none_e1(self):
		"""Test add as *array-array-none* for errors='a' - Array code i.
		"""
	...
	########################################################
	def test_add_array_array_array_f1(self):
		"""Test add as *array-array-array* for errors='a' - Array code i.
		"""
		# This version is expected to pass.
		arrayfunc.add(self.inparray1a, self.inparray2a, self.dataout, matherrors=True)
...
##############################################################################
class add_general_l(unittest.TestCase):
	"""Test add for basic general function operation using numeric 
	data -25,-1,0,1,25.
	test_template_op
	"""
...
class add_opt_param_errors_l(unittest.TestCase):
	...
	########################################################
	def test_add_array_num_none_a1(self):
		"""Test add as *array-num-none* for errors='a' - Array code l.
		"""
		inpvalue = self.inparray2a[0]
	...
	########################################################
	def test_add_array_num_array_b1(self):
		"""Test add as *array-num-array* for errors='a' - Array code l.
		"""
		inpvalue = self.inparray2a[0]
	...
	########################################################
	def test_add_num_array_none_c1(self):
		"""Test add as *num-array-none* for errors='a' - Array code l.
		"""
		inpvalue = self.inparray1a[0]
	...
	########################################################
	def test_add_num_array_array_d1(self):
		"""Test add as *num-array-array* for errors='a' - Array code l.
		"""
		inpvalue = self.inparray1a[0]
	...
	########################################################
	def test_add_array_array_none_e1(self):
		"""Test add as *array-array-none* for errors='a' - Array code l.
		"""
	...
	########################################################
	def test_add_array_array_array_f1(self):
		"""Test add as *array-array-array* for errors='a' - Array code l.
		"""
		# This version is expected to pass.
		arrayfunc.add(self.inparray1a, self.inparray2a, self.dataout, matherrors=True)
...
##############################################################################
class add_general_q(unittest.TestCase):
	"""Test add for basic general function operation using numeric 
	data -25,-1,0,1,25.
	test_template_op
	"""
...
class add_opt_param_errors_q(unittest.TestCase):
	...
	########################################################
	def test_add_array_num_none_a1(self):
		"""Test add as *array-num-none* for errors='a' - Array code q.
		"""
		inpvalue = self.inparray2a[0]
	...
	########################################################
	def test_add_array_num_array_b1(self):
		"""Test add as *array-num-array* for errors='a' - Array code q.
		"""
		inpvalue = self.inparray2a[0]
	...
	########################################################
	def test_add_num_array_none_c1(self):
		"""Test add as *num-array-none* for errors='a' - Array code q.
		"""
		inpvalue = self.inparray1a[0]
	...
	########################################################
	def test_add_num_array_array_d1(self):
		"""Test add as *num-array-array* for errors='a' - Array code q.
		"""
		inpvalue = self.inparray1a[0]
	...
	########################################################
	def test_add_array_array_none_e1(self):
		"""Test add as *array-array-none* for errors='a' - Array code q.
		"""
	...
	########################################################
	def test_add_array_array_array_f1(self):
		"""Test add as *array-array-array* for errors='a' - Array code q.
		"""
		# This version is expected to pass.
		arrayfunc.add(self.inparray1a, self.inparray2a, self.dataout, matherrors=True)
...
##############################################################################
class add_general_f(unittest.TestCase):
	"""Test add for basic general function operation using numeric 
...
class add_opt_param_errors_f(unittest.TestCase):
	...
	########################################################
	def test_add_array_num_none_a1(self):
		"""Test add as *array-num-none* for errors='a' - Array code f.
		"""
		inpvalue = self.inparray2a[0]
	...
	########################################################
	def test_add_array_num_array_b1(self):
		"""Test add as *array-num-array* for errors='a' - Array code f.
		"""
		inpvalue = self.inparray2a[0]
	...
	########################################################
	def test_add_num_array_none_c1(self):
		"""Test add as *num-array-none* for errors='a' - Array code f.
		"""
		inpvalue = self.inparray1a[0]
	...
	########################################################
	def test_add_num_array_array_d1(self):
		"""Test add as *num-array-array* for errors='a' - Array code f.
		"""
		inpvalue = self.inparray1a[0]
	...
	########################################################
	def test_add_array_array_none_e1(self):
		"""Test add as *array-array-none* for errors='a' - Array code f.
		"""
	...
	########################################################
	def test_add_array_array_array_f1(self):
		"""Test add as *array-array-array* for errors='a' - Array code f.
		"""
		# This version is expected to pass.
		arrayfunc.add(self.inparray1a, self.inparray2a, self.dataout, matherrors=True)
...
##############################################################################
class add_general_d(unittest.TestCase):
	"""Test add for basic general function operation using numeric 
	data -25.0,-1.0,0.0,1.0,25.0.
	test_template_op
	"""
...
class add_opt_param_errors_d(unittest.TestCase):
	...
	########################################################
	def test_add_array_num_none_a1(self):
		"""Test add as *array-num-none* for errors='a' - Array code d.
		"""
		inpvalue = self.inparray2a[0]
	...
	########################################################
	def test_add_array_num_array_b1(self):
		"""Test add as *array-num-array* for errors='a' - Array code d.
		"""
		inpvalue = self.inparray2a[0]
	...
	########################################################
	def test_add_num_array_none_c1(self):
		"""Test add as *num-array-none* for errors='a' - Array code d.
		"""
		inpvalue = self.inparray1a[0]
	...
	########################################################
	def test_add_num_array_array_d1(self):
		"""Test add as *num-array-array* for errors='a' - Array code d.
		"""
		inpvalue = self.inparray1a[0]
	...
	########################################################
	def test_add_array_array_none_e1(self):
		"""Test add as *array-array-none* for errors='a' - Array code d.
		"""
	...
	########################################################
	def test_add_array_array_array_f1(self):
		"""Test add as *array-array-array* for errors='a' - Array code d.
		"""
		# This version is expected to pass.
		arrayfunc.add(self.inparray1a, self.inparray2a, self.dataout, matherrors=True)

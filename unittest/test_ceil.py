...
##############################################################################
class ceil_general_even_arraysize_with_simd_f(unittest.TestCase):
	...
	def setUp(self):
		...
		self.expected = [math.ceil(x) for x in self.data]
	...
	########################################################
	def test_ceil_basic_array_none_a1(self):
		"""Test ceil as *array-none* for basic function - Array code f.
		"""
		arrayfunc.ceil(self.data )
	...
	########################################################
	def test_ceil_basic_array_none_a2(self):
		"""Test ceil as *array-none* for basic function with matherrors=True - Array code f.
		"""
		arrayfunc.ceil(self.data, matherrors=True )
	...
	########################################################
	def test_ceil_basic_array_none_a3(self):
		"""Test ceil as *array-none* for basic function with maxlen - Array code f.
		"""
		arrayfunc.ceil(self.data, maxlen=self.limited )
	...
	########################################################
	def test_ceil_basic_array_none_a4(self):
		"""Test ceil as *array-none* for basic function with maxlen and matherrors=True - Array code f.
		"""
		arrayfunc.ceil(self.data, maxlen=self.limited, matherrors=True )
	...
	########################################################
	def test_ceil_basic_array_array_b1(self):
		"""Test ceil as *array-array* for basic function - Array code f.
		"""
		arrayfunc.ceil(self.data, self.dataout )
	...
	########################################################
	def test_ceil_basic_array_array_b2(self):
		"""Test ceil as *array-array* for basic function with matherrors=True - Array code f.
		"""
		arrayfunc.ceil(self.data, self.dataout, matherrors=True )
	...
	########################################################
	def test_ceil_basic_array_array_b3(self):
		"""Test ceil as *array-array* for basic function with maxlen - Array code f.
		"""
		arrayfunc.ceil(self.data, self.dataout, maxlen=self.limited )
	...
	########################################################
	def test_ceil_basic_array_array_b4(self):
		"""Test ceil as *array-array* for basic function with maxlen and matherrors=True - Array code f.
		"""
		arrayfunc.ceil(self.data, self.dataout, maxlen=self.limited, matherrors=True )
...
##############################################################################
class ceil_general_odd_arraysize_with_simd_f(unittest.TestCase):
	"""Test for basic general function operation.
	test_template_noparams
	"""
...
##############################################################################
class ceil_general_even_arraysize_without_simd_f(unittest.TestCase):
	"""Test for basic general function operation.
	test_template_noparams
	"""
	...
	def test_ceil_basic_array_none_a1(self):
		"""Test ceil as *array-none* for basic function - Array code f.
		"""
		arrayfunc.ceil(self.data , nosimd=True)
	...
	def test_ceil_basic_array_none_a2(self):
		"""Test ceil as *array-none* for basic function with matherrors=True - Array code f.
		"""
		arrayfunc.ceil(self.data, matherrors=True , nosimd=True)
	...
	def test_ceil_basic_array_none_a3(self):
		"""Test ceil as *array-none* for basic function with maxlen - Array code f.
		"""
		arrayfunc.ceil(self.data, maxlen=self.limited , nosimd=True)
	...
	def test_ceil_basic_array_none_a4(self):
		"""Test ceil as *array-none* for basic function with maxlen and matherrors=True - Array code f.
		"""
		arrayfunc.ceil(self.data, maxlen=self.limited, matherrors=True , nosimd=True)
	...
	def test_ceil_basic_array_array_b1(self):
		"""Test ceil as *array-array* for basic function - Array code f.
		"""
		arrayfunc.ceil(self.data, self.dataout , nosimd=True)
	...
	def test_ceil_basic_array_array_b2(self):
		"""Test ceil as *array-array* for basic function with matherrors=True - Array code f.
		"""
		arrayfunc.ceil(self.data, self.dataout, matherrors=True , nosimd=True)
	...
	def test_ceil_basic_array_array_b3(self):
		"""Test ceil as *array-array* for basic function with maxlen - Array code f.
		"""
		arrayfunc.ceil(self.data, self.dataout, maxlen=self.limited , nosimd=True)
	...
	def test_ceil_basic_array_array_b4(self):
		"""Test ceil as *array-array* for basic function with maxlen and matherrors=True - Array code f.
		"""
		arrayfunc.ceil(self.data, self.dataout, maxlen=self.limited, matherrors=True , nosimd=True)
...
class ceil_param_errors_f(unittest.TestCase):
	...
	def test_ceil_array_none_b1(self):
		"""Test ceil as *array-none* for matherrors='a' - Array code f.
		"""
		...
		# This is the actual test.
		with self.assertRaises(TypeError):
			arrayfunc.ceil(floatarray, matherrors='a')
	...
	def test_ceil_array_num_array_d1(self):
		"""Test ceil as *array-num-array* for matherrors='a' - Array code f.
		"""
		# This version is expected to pass.
		...
		# This is the actual test.
		with self.assertRaises(TypeError):
			arrayfunc.ceil(self.floatarray, self.dataout, matherrors='a')
...
##############################################################################
class ceil_param_nosimd_errors_f(unittest.TestCase):
	...
	########################################################
	def test_ceil_array_none_b1(self):
		"""Test ceil as *array-none* for nosimd='a' - Array code f.
		"""
		# Copy the array so we don't change the original data.
		floatarray = copy.copy(self.floatarray)

		# This version is expected to pass.
		arrayfunc.ceil(floatarray, nosimd=True)

		floatarray = copy.copy(self.floatarray)

		# This is the actual test.
		with self.assertRaises(TypeError):
			arrayfunc.ceil(floatarray, nosimd='a')


	########################################################
	def test_ceil_array_num_array_d1(self):
		"""Test ceil as *array-num-array* for nosimd='a' - Array code f.
		"""
		# This version is expected to pass.
		arrayfunc.ceil(self.floatarray, self.dataout, nosimd=True)

		# This is the actual test.
		with self.assertRaises(TypeError):
			arrayfunc.ceil(self.floatarray, self.dataout, nosimd='a')
...
##############################################################################
class ceil_general_even_arraysize_with_simd_d(unittest.TestCase):
	"""Test for basic general function operation.
	test_template_noparams
	"""
	...
	########################################################
	def test_ceil_basic_array_none_a1(self):
		"""Test ceil as *array-none* for basic function - Array code d.
		"""
		arrayfunc.ceil(self.data )
	...
	########################################################
	def test_ceil_basic_array_none_a2(self):
		"""Test ceil as *array-none* for basic function with matherrors=True - Array code d.
		"""
		arrayfunc.ceil(self.data, matherrors=True )
	...
	########################################################
	def test_ceil_basic_array_none_a3(self):
		"""Test ceil as *array-none* for basic function with maxlen - Array code d.
		"""
		arrayfunc.ceil(self.data, maxlen=self.limited )
	...
	########################################################
	def test_ceil_basic_array_none_a4(self):
		"""Test ceil as *array-none* for basic function with maxlen and matherrors=True - Array code d.
		"""
		arrayfunc.ceil(self.data, maxlen=self.limited, matherrors=True )
	...
	########################################################
	def test_ceil_basic_array_array_b1(self):
		"""Test ceil as *array-array* for basic function - Array code d.
		"""
		arrayfunc.ceil(self.data, self.dataout )
	...
	########################################################
	def test_ceil_basic_array_array_b2(self):
		"""Test ceil as *array-array* for basic function with matherrors=True - Array code d.
		"""
		arrayfunc.ceil(self.data, self.dataout, matherrors=True )
	...
	########################################################
	def test_ceil_basic_array_array_b3(self):
		"""Test ceil as *array-array* for basic function with maxlen - Array code d.
		"""
		arrayfunc.ceil(self.data, self.dataout, maxlen=self.limited )
	...
	########################################################
	def test_ceil_basic_array_array_b4(self):
		"""Test ceil as *array-array* for basic function with maxlen and matherrors=True - Array code d.
		"""
		arrayfunc.ceil(self.data, self.dataout, maxlen=self.limited, matherrors=True )
...
##############################################################################
class ceil_general_odd_arraysize_with_simd_d(unittest.TestCase):
	"""Test for basic general function operation.
	test_template_noparams
	"""
...
##############################################################################
class ceil_general_even_arraysize_without_simd_d(unittest.TestCase):
	"""Test for basic general function operation.
	test_template_noparams
	"""
...
class ceil_param_errors_d(unittest.TestCase):
	...
	########################################################
	def test_ceil_array_none_b1(self):
		"""Test ceil as *array-none* for matherrors='a' - Array code d.
		"""
		# Copy the array so we don't change the original data.
		floatarray = copy.copy(self.floatarray)
	...
	########################################################
	def test_ceil_array_num_array_d1(self):
		"""Test ceil as *array-num-array* for matherrors='a' - Array code d.
		"""
		# This version is expected to pass.
		arrayfunc.ceil(self.floatarray, self.dataout, matherrors=True)
...
##############################################################################
class ceil_param_nosimd_errors_d(unittest.TestCase):
	"""Test for invalid nosimd parameters.
	param_nosimd_invalid_template
	"""
	...
	########################################################
	def test_ceil_array_none_b1(self):
		"""Test ceil as *array-none* for nosimd='a' - Array code d.
		"""
		# Copy the array so we don't change the original data.
		floatarray = copy.copy(self.floatarray)
	...
	########################################################
	def test_ceil_array_num_array_d1(self):
		"""Test ceil as *array-num-array* for nosimd='a' - Array code d.
		"""
		# This version is expected to pass.
		arrayfunc.ceil(self.floatarray, self.dataout, nosimd=True)

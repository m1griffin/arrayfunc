...
##############################################################################
class atan_general_even_arraysize_without_simd_f(unittest.TestCase):
	...
	def setUp(self):
		...
		self.expected = [math.atan(x) for x in self.data]
	...
	########################################################
	def test_atan_basic_array_none_a1(self):
		"""Test atan as *array-none* for basic function - Array code f.
		"""
		arrayfunc.atan(self.data )
	...
	########################################################
	def test_atan_basic_array_none_a2(self):
		"""Test atan as *array-none* for basic function with matherrors=True - Array code f.
		"""
		arrayfunc.atan(self.data, matherrors=True )
	...
	########################################################
	def test_atan_basic_array_none_a3(self):
		"""Test atan as *array-none* for basic function with maxlen - Array code f.
		"""
		arrayfunc.atan(self.data, maxlen=self.limited )
	...
	########################################################
	def test_atan_basic_array_none_a4(self):
		"""Test atan as *array-none* for basic function with maxlen and matherrors=True - Array code f.
		"""
		arrayfunc.atan(self.data, maxlen=self.limited, matherrors=True )
	...
	########################################################
	def test_atan_basic_array_array_b1(self):
		"""Test atan as *array-array* for basic function - Array code f.
		"""
		arrayfunc.atan(self.data, self.dataout )
	...
	########################################################
	def test_atan_basic_array_array_b2(self):
		"""Test atan as *array-array* for basic function with matherrors=True - Array code f.
		"""
		arrayfunc.atan(self.data, self.dataout, matherrors=True )
	...
	########################################################
	def test_atan_basic_array_array_b3(self):
		"""Test atan as *array-array* for basic function with maxlen - Array code f.
		"""
		arrayfunc.atan(self.data, self.dataout, maxlen=self.limited )
	...
	########################################################
	def test_atan_basic_array_array_b4(self):
		"""Test atan as *array-array* for basic function with maxlen and matherrors=True - Array code f.
		"""
		arrayfunc.atan(self.data, self.dataout, maxlen=self.limited, matherrors=True )
...
class atan_param_errors_f(unittest.TestCase):
	...
	def test_atan_array_none_b1(self):
		"""Test atan as *array-none* for matherrors='a' - Array code f.
		"""
		...
		# This is the actual test.
		with self.assertRaises(TypeError):
			arrayfunc.atan(floatarray, matherrors='a')
	...
	def test_atan_array_num_array_d1(self):
		"""Test atan as *array-num-array* for matherrors='a' - Array code f.
		"""
		# This version is expected to pass.
		...
		# This is the actual test.
		with self.assertRaises(TypeError):
			arrayfunc.atan(self.floatarray, self.dataout, matherrors='a')
...
##############################################################################
class atan_general_even_arraysize_without_simd_d(unittest.TestCase):
	"""Test for basic general function operation.
	test_template_noparams
	"""
	...
	########################################################
	def test_atan_basic_array_none_a1(self):
		"""Test atan as *array-none* for basic function - Array code d.
		"""
		arrayfunc.atan(self.data )
	...
	########################################################
	def test_atan_basic_array_none_a2(self):
		"""Test atan as *array-none* for basic function with matherrors=True - Array code d.
		"""
		arrayfunc.atan(self.data, matherrors=True )
	...
	########################################################
	def test_atan_basic_array_none_a3(self):
		"""Test atan as *array-none* for basic function with maxlen - Array code d.
		"""
		arrayfunc.atan(self.data, maxlen=self.limited )
	...
	########################################################
	def test_atan_basic_array_none_a4(self):
		"""Test atan as *array-none* for basic function with maxlen and matherrors=True - Array code d.
		"""
		arrayfunc.atan(self.data, maxlen=self.limited, matherrors=True )
	...
	########################################################
	def test_atan_basic_array_array_b1(self):
		"""Test atan as *array-array* for basic function - Array code d.
		"""
		arrayfunc.atan(self.data, self.dataout )
	...
	########################################################
	def test_atan_basic_array_array_b2(self):
		"""Test atan as *array-array* for basic function with matherrors=True - Array code d.
		"""
		arrayfunc.atan(self.data, self.dataout, matherrors=True )
	...
	########################################################
	def test_atan_basic_array_array_b3(self):
		"""Test atan as *array-array* for basic function with maxlen - Array code d.
		"""
		arrayfunc.atan(self.data, self.dataout, maxlen=self.limited )
	...
	########################################################
	def test_atan_basic_array_array_b4(self):
		"""Test atan as *array-array* for basic function with maxlen and matherrors=True - Array code d.
		"""
		arrayfunc.atan(self.data, self.dataout, maxlen=self.limited, matherrors=True )
...
class atan_param_errors_d(unittest.TestCase):
	...
	########################################################
	def test_atan_array_none_b1(self):
		"""Test atan as *array-none* for matherrors='a' - Array code d.
		"""
		# Copy the array so we don't change the original data.
		floatarray = copy.copy(self.floatarray)
	...
	########################################################
	def test_atan_array_num_array_d1(self):
		"""Test atan as *array-num-array* for matherrors='a' - Array code d.
		"""
		# This version is expected to pass.
		arrayfunc.atan(self.floatarray, self.dataout, matherrors=True)

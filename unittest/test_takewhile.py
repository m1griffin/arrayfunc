...
class takewhile_operator_b(unittest.TestCase):
	...
	def TakeWhile(self, op, data, param, maxlen=0):
		...
		result = list(itertools.takewhile(opval, testdata))
...
##############################################################################
class takewhile_params_b(unittest.TestCase):
	...
	def test_param_invalid_keyword_params(self):
		...
		"""
		with self.assertRaises(TypeError):
			result = arrayfunc.takewhile('==', self.data, self.dataout, 100, xx=2)
	...
	def test_param_invalid_keyword_param_type(self):
		...
		"""
		with self.assertRaises(TypeError):
			result = arrayfunc.takewhile('==', self.data, self.dataout, 100, maxlen='x')
	...
	def test_param_invalid_opcode_param_value(self):
		...
		with self.assertRaises(ValueError):
			result = arrayfunc.takewhile('!', self.data, self.dataout, 100)
	...
	def test_param_invalid_opcode_param_type(self):
		...
		"""
		with self.assertRaises(TypeError):
			result = arrayfunc.takewhile(62, self.data, self.dataout, 100)
	...
	def test_param_invalid_input_array_param_length(self):
		...
		with self.assertRaises(IndexError):
			result = arrayfunc.takewhile('==', self.dataempty, self.dataout, 100)
	...
	def test_param_invalid_output_array_param_length(self):
		...
		"""
		with self.assertRaises(IndexError):
			result = arrayfunc.takewhile('==', self.data, self.dataempty, 100)
	...
	def test_param_invalid_array_param_type_02(self):
		...
		"""
		with self.assertRaises(TypeError):
			result = arrayfunc.takewhile('==', self.data, self.dataout, 100.5)
...
##############################################################################
class takewhile_paramovfl_b(unittest.TestCase):
...
##############################################################################
class takewhile_params_h(unittest.TestCase):
	"""Test for basic parameter function.
	"""
...
##############################################################################
class takewhile_paramovfl_h(unittest.TestCase):
	"""Test for testing parameter overflow.
	"""
...
##############################################################################
class takewhile_params_i(unittest.TestCase):
	"""Test for basic parameter function.
	"""
...
##############################################################################
class takewhile_paramovfl_i(unittest.TestCase):
	"""Test for testing parameter overflow.
	"""
...
##############################################################################
class takewhile_params_l(unittest.TestCase):
	"""Test for basic parameter function.
	"""
...
##############################################################################
class takewhile_paramovfl_l(unittest.TestCase):
	"""Test for testing parameter overflow.
	"""
...
##############################################################################
class takewhile_params_q(unittest.TestCase):
	"""Test for basic parameter function.
	"""
...
##############################################################################
class takewhile_paramovfl_q(unittest.TestCase):
	"""Test for testing parameter overflow.
	"""
...
##############################################################################
class takewhile_params_f(unittest.TestCase):
	"""Test for basic parameter function.
	"""
	...
	def test_param_invalid_keyword_params(self):
		...
		"""
		with self.assertRaises(TypeError):
			result = arrayfunc.takewhile('==', self.data, self.dataout, 100.0, xx=2)
	...
	def test_param_invalid_keyword_param_type(self):
		...
		"""
		with self.assertRaises(TypeError):
			result = arrayfunc.takewhile('==', self.data, self.dataout, 100.0, maxlen='x')
	...
	def test_param_invalid_opcode_param_value(self):
		...
		"""
		with self.assertRaises(ValueError):
			result = arrayfunc.takewhile('!', self.data, self.dataout, 100.0)
	...
	def test_param_invalid_opcode_param_type(self):
		...
		"""
		with self.assertRaises(TypeError):
			result = arrayfunc.takewhile(62, self.data, self.dataout, 100.0)
	...
	def test_param_invalid_input_array_param_value(self):
		...
		"""
		with self.assertRaises(TypeError):
			result = arrayfunc.takewhile('==', 99, self.dataout, 100.0)
	...
	def test_param_invalid_output_array_param_value(self):
		...
		"""
		with self.assertRaises(TypeError):
			result = arrayfunc.takewhile('==', self.data, 99, 100.0)
...
##############################################################################
class takewhile_paramovfl_f(unittest.TestCase):
	"""Test for testing parameter overflow.
	"""
...
##############################################################################
class takewhile_params_d(unittest.TestCase):
	"""Test for basic parameter function.
	"""
...
##############################################################################
class takewhile_nonfinite_f(unittest.TestCase):
	...
	def test_nonfinite_04(self):
		...
		"""
		with self.assertRaises(TypeError):
			result = arrayfunc.takewhile('==', self.data, self.dataout, 100.0, maxlen=math.nan)
	...
	def test_nonfinite_05(self):
		...
		"""
		with self.assertRaises(TypeError):
			result = arrayfunc.takewhile('==', self.data, self.dataout, 100.0, maxlen=math.inf)
...
##############################################################################
class takewhile_nonfinite_d(unittest.TestCase):
	"""Test for nan, inf, -inf.
	"""

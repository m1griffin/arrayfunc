...
class amax_operator_bytes(unittest.TestCase):
	...
	########################################################
	def test_function_01(self):
		"""Test amax  - Array code bytes. General test with SIMD.
		"""
		data = array.array('B', itertools.chain(range(1,10,2), range(88,12,-3)))
		data = bytes(data)
		result = arrayfunc.amax(data)
	...
	########################################################
	def test_function_02(self):
		"""Test amax  - Array code bytes. General test without SIMD.
		"""
		data = array.array('B', itertools.chain(range(1,10,2), range(88,12,-3)))
		data = bytes(data)
		result = arrayfunc.amax(data, nosimd=True)
	...
	########################################################
	def test_function_03(self):
		"""Test amax  - Array code bytes. Test increasing values with SIMD.
		"""
		data = array.array('B', range(1,100))
		data = bytes(data)
		result = arrayfunc.amax(data)
	...
	########################################################
	def test_function_04(self):
		"""Test amax  - Array code bytes. Test increasing values without SIMD.
		"""
		data = array.array('B', range(1,100))
		data = bytes(data)
		result = arrayfunc.amax(data, nosimd=True)
	...
	########################################################
	def test_function_05(self):
		"""Test amax  - Array code bytes. Test decreasing values with SIMD.
		"""
		data = array.array('B', range(100,1,-1))
		data = bytes(data)
		result = arrayfunc.amax(data)
	...
	########################################################
	def test_function_06(self):
		"""Test amax  - Array code bytes. Test decreasing values without SIMD.
		"""
		data = array.array('B', range(100,1,-1))
		data = bytes(data)
		result = arrayfunc.amax(data, nosimd=True)
	...
	########################################################
	def test_function_07(self):
		"""Test amax  - Array code bytes. Test finding max for data type with SIMD.
		"""
		data = array.array('B', itertools.chain(range(1,10,2), [self.MaxVal], range(88,12,-3)))
		data = bytes(data)
		result = arrayfunc.amax(data)
	...
	########################################################
	def test_function_08(self):
		"""Test amax  - Array code bytes. Test finding max for data type without SIMD.
		"""
		data = array.array('B', itertools.chain(range(1,10,2), [self.MaxVal], range(88,12,-3)))
		data = bytes(data)
		result = arrayfunc.amax(data, nosimd=True)
	...
	########################################################
	def test_function_09(self):
		"""Test amax  - Array code bytes. Test finding value from array that contains min for data type with SIMD.
		"""
		data = array.array('B', itertools.chain([self.MinVal] * 10, range(1,20), [self.MinVal] * 10))
		data = bytes(data)
		result = arrayfunc.amax(data)
	...
	########################################################
	def test_function_10(self):
		"""Test amax  - Array code bytes. Test finding value from array that contains min for data type without SIMD.
		"""
		data = array.array('B', itertools.chain([self.MinVal] * 10, range(1,20), [self.MinVal] * 10))
		data = bytes(data)
		result = arrayfunc.amax(data, nosimd=True)
	...
	########################################################
	def test_function_11(self):
		"""Test amax  - Array code bytes. Test optional lim parameter with SIMD.
		"""
		data = array.array('B', itertools.chain(range(1,10,2), [self.MaxVal], range(88,12,-3)))
		data = bytes(data)
		result = arrayfunc.amax(data, maxlen=5)
	...
	########################################################
	def test_function_12(self):
		"""Test amax  - Array code bytes. Test optional lim parameter without SIMD.
		"""
		data = array.array('B', itertools.chain(range(1,10,2), [self.MaxVal], range(88,12,-3)))
		data = bytes(data)
		result = arrayfunc.amax(data, maxlen=5, nosimd=True)
	...
	########################################################
	def test_function_13(self):
		"""Test amax  - Array code bytes. Test invalid parameter type with SIMD.
		"""
		with self.assertRaises(TypeError):
			result = arrayfunc.amax(1)
	...
	########################################################
	def test_function_14(self):
		"""Test amax  - Array code bytes. Test invalid parameter type without SIMD.
		"""
		with self.assertRaises(TypeError):
			result = arrayfunc.amax(1, nosimd=True)

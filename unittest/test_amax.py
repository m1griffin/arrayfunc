...
class amax_operator_b(unittest.TestCase):
	...
	def test_function_01(self):
		"""Test amax  - Array code b. General test.
		"""
	...
	def test_function_02(self):
		"""Test amax  - Array code b. Test increasing values.
		"""
	...
	def test_function_03(self):
		"""Test amax  - Array code b. Test decreasing values.
		"""
	...
	def test_function_04(self):
		"""Test amax  - Array code b. Test finding max for data type.
		"""
	...
	def test_function_05(self):
		"""Test amax  - Array code b. Test finding value from array that contains min for data type.
		"""
	...
	def test_function_06(self):
		"""Test amax  - Array code b. Test optional lim parameter.
		"""
		data = array.array('b', itertools.chain(range(1,10,2), [self.MaxVal], range(11,-88,-3)))
	...
	def test_function_07(self):
		"""Test amax  - Array code b. Test invalid parameter type.
		"""
...
class amax_operator_h(unittest.TestCase):
	...
	########################################################
	def test_function_01(self):
		"""Test amax  - Array code h. General test.
		"""
	...
	########################################################
	def test_function_02(self):
		"""Test amax  - Array code h. Test increasing values.
		"""
	...
	########################################################
	def test_function_03(self):
		"""Test amax  - Array code h. Test decreasing values.
		"""
	...
	########################################################
	def test_function_04(self):
		"""Test amax  - Array code h. Test finding max for data type.
		"""
	...
	########################################################
	def test_function_05(self):
		"""Test amax  - Array code h. Test finding value from array that contains min for data type.
		"""
	...
	########################################################
	def test_function_06(self):
		"""Test amax  - Array code h. Test optional lim parameter.
		"""
		data = array.array('h', itertools.chain(range(1,10,2), [self.MaxVal], range(11,-88,-3)))
	...
	########################################################
	def test_function_07(self):
		"""Test amax  - Array code h. Test invalid parameter type.
		"""
		with self.assertRaises(TypeError):
			result = arrayfunc.amax(1)
...
class amax_operator_i(unittest.TestCase):
	...
	########################################################
	def test_function_01(self):
		"""Test amax  - Array code i. General test.
		"""
	...
	########################################################
	def test_function_02(self):
		"""Test amax  - Array code i. Test increasing values.
		"""
	...
	########################################################
	def test_function_03(self):
		"""Test amax  - Array code i. Test decreasing values.
		"""
	...
	########################################################
	def test_function_04(self):
		"""Test amax  - Array code i. Test finding max for data type.
		"""
	...
	########################################################
	def test_function_05(self):
		"""Test amax  - Array code i. Test finding value from array that contains min for data type.
		"""
	...
	########################################################
	def test_function_06(self):
		"""Test amax  - Array code i. Test optional lim parameter.
		"""
		data = array.array('i', itertools.chain(range(1,10,2), [self.MaxVal], range(11,-88,-3)))
	...
	########################################################
	def test_function_07(self):
		"""Test amax  - Array code i. Test invalid parameter type.
		"""
		with self.assertRaises(TypeError):
			result = arrayfunc.amax(1)
...
class amax_operator_l(unittest.TestCase):
	...
	########################################################
	def test_function_01(self):
		"""Test amax  - Array code l. General test.
		"""
	...
	########################################################
	def test_function_02(self):
		"""Test amax  - Array code l. Test increasing values.
		"""
	...
	########################################################
	def test_function_03(self):
		"""Test amax  - Array code l. Test decreasing values.
		"""
	...
	########################################################
	def test_function_04(self):
		"""Test amax  - Array code l. Test finding max for data type.
		"""
	...
	########################################################
	def test_function_05(self):
		"""Test amax  - Array code l. Test finding value from array that contains min for data type.
		"""
	...
	########################################################
	def test_function_06(self):
		"""Test amax  - Array code l. Test optional lim parameter.
		"""
		data = array.array('l', itertools.chain(range(1,10,2), [self.MaxVal], range(11,-88,-3)))
	...
	########################################################
	def test_function_07(self):
		"""Test amax  - Array code l. Test invalid parameter type.
		"""
		with self.assertRaises(TypeError):
			result = arrayfunc.amax(1)
...
class amax_operator_q(unittest.TestCase):
	...
	########################################################
	def test_function_01(self):
		"""Test amax  - Array code q. General test.
		"""
	...
	########################################################
	def test_function_02(self):
		"""Test amax  - Array code q. Test increasing values.
		"""
	...
	########################################################
	def test_function_03(self):
		"""Test amax  - Array code q. Test decreasing values.
		"""
	...
	########################################################
	def test_function_04(self):
		"""Test amax  - Array code q. Test finding max for data type.
		"""
	...
	########################################################
	def test_function_05(self):
		"""Test amax  - Array code q. Test finding value from array that contains min for data type.
		"""
	...
	########################################################
	def test_function_06(self):
		"""Test amax  - Array code q. Test optional lim parameter.
		"""
		data = array.array('q', itertools.chain(range(1,10,2), [self.MaxVal], range(11,-88,-3)))
	...
	########################################################
	def test_function_07(self):
		"""Test amax  - Array code q. Test invalid parameter type.
		"""
		with self.assertRaises(TypeError):
			result = arrayfunc.amax(1)
...
class amax_operator_f(unittest.TestCase):
	...
	########################################################
	def test_function_01(self):
		"""Test amax  - Array code f. General test.
		"""
	...
	########################################################
	def test_function_02(self):
		"""Test amax  - Array code f. Test increasing values.
		"""
	...
	########################################################
	def test_function_03(self):
		"""Test amax  - Array code f. Test decreasing values.
		"""
	...
	########################################################
	def test_function_04(self):
		"""Test amax  - Array code f. Test finding max for data type.
		"""
	...
	########################################################
	def test_function_05(self):
		"""Test amax  - Array code f. Test finding value from array that contains min for data type.
		"""
	...
	########################################################
	def test_function_06(self):
		"""Test amax  - Array code f. Test optional lim parameter.
		"""
		data = array.array('f', [float(x) for x in itertools.chain(range(1,10,2), [self.MaxVal], range(11,-88,-3))])
	...
	########################################################
	def test_function_07(self):
		"""Test amax  - Array code f. Test invalid parameter type.
		"""
		with self.assertRaises(TypeError):
			result = arrayfunc.amax(1)
...
class amax_operator_d(unittest.TestCase):
	...
	########################################################
	def test_function_01(self):
		"""Test amax  - Array code d. General test.
		"""
	...
	########################################################
	def test_function_02(self):
		"""Test amax  - Array code d. Test increasing values.
		"""
	...
	########################################################
	def test_function_03(self):
		"""Test amax  - Array code d. Test decreasing values.
		"""
	...
	########################################################
	def test_function_04(self):
		"""Test amax  - Array code d. Test finding max for data type.
		"""
	...
	########################################################
	def test_function_05(self):
		"""Test amax  - Array code d. Test finding value from array that contains min for data type.
		"""
	...
	########################################################
	def test_function_06(self):
		"""Test amax  - Array code d. Test optional lim parameter.
		"""
		data = array.array('d', [float(x) for x in itertools.chain(range(1,10,2), [self.MaxVal], range(11,-88,-3))])
	...
	########################################################
	def test_function_07(self):
		"""Test amax  - Array code d. Test invalid parameter type.
		"""
		with self.assertRaises(TypeError):
			result = arrayfunc.amax(1)
...
##############################################################################
class amax_operator_bytes(unittest.TestCase):
	"""Test for basic operator function.
	"""
	...
	########################################################
	def test_function_01(self):
		"""Test amax  - Array code bytes. General test.
		"""
		data = array.array('B', itertools.chain(range(1,10,2), range(88,12,-3)))
		data = bytes(data)
		result = arrayfunc.amax(data)
	...
	########################################################
	def test_function_02(self):
		"""Test amax  - Array code bytes. Test increasing values.
		"""
		data = array.array('B', range(1,100))
		data = bytes(data)
		result = arrayfunc.amax(data)
	...
	########################################################
	def test_function_03(self):
		"""Test amax  - Array code bytes. Test decreasing values.
		"""
		data = array.array('B', range(100,1,-1))
		data = bytes(data)
		result = arrayfunc.amax(data)
	...
	########################################################
	def test_function_04(self):
		"""Test amax  - Array code bytes. Test finding max for data type.
		"""
		data = array.array('B', itertools.chain(range(1,10,2), [self.MaxVal], range(88,12,-3)))
		data = bytes(data)
		result = arrayfunc.amax(data)
	...
	########################################################
	def test_function_05(self):
		"""Test amax  - Array code bytes. Test finding value from array that contains min for data type.
		"""
		data = array.array('B', itertools.chain([self.MinVal] * 10, range(1,20), [self.MinVal] * 10))
		data = bytes(data)
		result = arrayfunc.amax(data)
	...
	########################################################
	def test_function_06(self):
		"""Test amax  - Array code bytes. Test optional lim parameter.
		"""
		data = array.array('B', itertools.chain(range(1,10,2), [self.MaxVal], range(88,12,-3)))
		data = bytes(data)
		result = arrayfunc.amax(data, maxlen=5)
	...
	########################################################
	def test_function_07(self):
		"""Test amax  - Array code bytes. Test invalid parameter type.
		"""
		with self.assertRaises(TypeError):
			result = arrayfunc.amax(1)
	...
	########################################################
	def test_function_08(self):
		"""Test amax  - Array code bytes. Test missing parameter.
		"""
		with self.assertRaises(TypeError):
			result = arrayfunc.amax()
	...
	########################################################
	def test_function_09(self):
		"""Test amax  - Array code bytes. Test excess parameters.
		"""
		data = array.array('B', itertools.chain(range(1,10,2), range(88,12,-3)))
		data = bytes(data)
		with self.assertRaises(TypeError):

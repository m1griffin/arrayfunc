...
##############################################################################
class mod_general_b(unittest.TestCase):
	"""Test mod for basic general function operation using numeric 
	data -2,-1,1,2.
	test_template_op
	"""
	...
	def setUp(self):
		...
		self.datay = [x for (x,y) in zip(itertools.cycle([-2,-1,1,2]), self.datax)]
	...
	def test_mod_basic_array_num_none_a2(self):
		...
		for testval in self.datay:
			with self.subTest(msg='Failed with parameter', testval = testval):
				...
				arrayfunc.mod(data1, testval, matherrors=True)
	...
	def test_mod_basic_array_num_none_a3(self):
		...
		for testval in self.datay:
			with self.subTest(msg='Failed with parameter', testval = testval):
				...
				arrayfunc.mod(data1, testval, maxlen=limited)
	...
	def test_mod_basic_array_num_none_a4(self):
		...
		for testval in self.datay:
			with self.subTest(msg='Failed with parameter', testval = testval):
				...
				arrayfunc.mod(data1, testval, matherrors=True, maxlen=limited)
	...
	def test_mod_basic_array_num_array_b1(self):
		...
		for testval in self.datay:
			with self.subTest(msg='Failed with parameter', testval = testval):
				...
				arrayfunc.mod(data1, testval, dataout)
	...
	def test_mod_basic_array_num_array_b2(self):
		...
		for testval in self.datay:
			with self.subTest(msg='Failed with parameter', testval = testval):
				...
				arrayfunc.mod(data1, testval, dataout, matherrors=True)
	...
	def test_mod_basic_array_num_array_b3(self):
		...
		for testval in self.datay:
			with self.subTest(msg='Failed with parameter', testval = testval):
				...
				arrayfunc.mod(data1, testval, dataout, maxlen=limited)
	...
	def test_mod_basic_array_num_array_b4(self):
		...
		for testval in self.datay:
			with self.subTest(msg='Failed with parameter', testval = testval):
				...
				arrayfunc.mod(data1, testval, dataout, matherrors=True, maxlen=limited)
	...
	def test_mod_basic_num_array_none_c2(self):
		...
		for testval in self.datax:
			with self.subTest(msg='Failed with parameter', testval = testval):
				...
				arrayfunc.mod(testval, data1, matherrors=True)
	...
	def test_mod_basic_num_array_none_c3(self):
		...
		for testval in self.datax:
			with self.subTest(msg='Failed with parameter', testval = testval):
				...
				arrayfunc.mod(testval, data1, maxlen=limited)
	...
	def test_mod_basic_num_array_none_c4(self):
		...
		for testval in self.datax:
			with self.subTest(msg='Failed with parameter', testval = testval):
				...
				arrayfunc.mod(testval, data1, matherrors=True, maxlen=limited)
	...
	def test_mod_basic_num_array_array_d1(self):
		...
		for testval in self.datax:
			with self.subTest(msg='Failed with parameter', testval = testval):
				...
				arrayfunc.mod(testval, data1, dataout)
	...
	def test_mod_basic_num_array_array_d2(self):
		...
		for testval in self.datax:
			with self.subTest(msg='Failed with parameter', testval = testval):
				...
				arrayfunc.mod(testval, data1, dataout, matherrors=True)
	...
	def test_mod_basic_num_array_array_d3(self):
		...
		for testval in self.datax:
			with self.subTest(msg='Failed with parameter', testval = testval):
				...
				arrayfunc.mod(testval, data1, dataout, maxlen=limited)
	...
	def test_mod_basic_num_array_array_d4(self):
		...
		for testval in self.datax:
			with self.subTest(msg='Failed with parameter', testval = testval):
				...
				arrayfunc.mod(testval, data1, dataout, matherrors=True, maxlen=limited)
	...
	########################################################
	def test_mod_basic_array_array_array_e5(self):
	...
	########################################################
	def test_mod_basic_array_array_array_e6(self):
		"""Test mod as *array-array-array* for basic function - Array code b.
		"""
		data1 = array.array('b', self.datax)
		data2 = array.array('b', self.datay)
	...
	########################################################
	def test_mod_basic_array_array_array_e7(self):
		"""Test mod as *array-array-array* for basic function - Array code b.
		"""
		data1 = array.array('b', self.datax)
		data2 = array.array('b', self.datay)
...
class mod_opt_param_errors_b(unittest.TestCase):
	...
	########################################################
	def test_mod_array_num_none_a1(self):
		"""Test mod as *array-num-none* for errors='a' - Array code b.
		"""
		...
		# This is the actual test.
		with self.assertRaises(TypeError):
			arrayfunc.mod(self.inparray1b, inpvalue, errors='a')
	...
	########################################################
	def test_mod_array_num_array_b1(self):
		"""Test mod as *array-num-array* for errors='a' - Array code b.
		"""
		inpvalue = self.inparray2a[0]
		...
		# This is the actual test.
		with self.assertRaises(TypeError):
			arrayfunc.mod(self.inparray1b, inpvalue, self.dataout, errors='a')
	...
	########################################################
	def test_mod_num_array_none_c1(self):
		"""Test mod as *num-array-none* for errors='a' - Array code b.
		"""
		...
		# This is the actual test.
		with self.assertRaises(TypeError):
			arrayfunc.mod(inpvalue, self.inparray2b, errors='a')
	...
	########################################################
	def test_mod_num_array_array_d1(self):
		"""Test mod as *num-array-array* for errors='a' - Array code b.
		"""
		inpvalue = self.inparray1a[0]
		...
		# This is the actual test.
		with self.assertRaises(TypeError):
			arrayfunc.mod(inpvalue, self.inparray2b, self.dataout, errors='a')
	...
	########################################################
	def test_mod_array_array_none_e1(self):
		"""Test mod as *array-array-none* for errors='a' - Array code b.
		"""
		...
		# This is the actual test.
		with self.assertRaises(TypeError):
			arrayfunc.mod(self.inparray1b, self.inparray2b, errors='a')
	...
	########################################################
	def test_mod_array_array_array_f1(self):
		"""Test mod as *array-array-array* for errors='a' - Array code b.
		"""
		# This version is expected to pass.
		...
		# This is the actual test.
		with self.assertRaises(TypeError):
			arrayfunc.mod(self.inparray1b, self.inparray2b, self.dataout, errors='a')
...
class overflow_signed_mindivminus1_b(unittest.TestCase):
	...
	########################################################
	def test_mod_array_num_none_a1(self):
		"""Test mod as *array-num-none* for min value % -1 - Array code b.
		"""
		# This version is expected to pass.
		arrayfunc.mod(self.inparray1amin, 1)

		# This is the actual test.
		with self.assertRaises(OverflowError):
			arrayfunc.mod(self.inparray1bmin, -1)


	########################################################
	def test_mod_array_num_none_a2(self):
		"""Test mod as *array-num-none* for min value % -1 matherrors=True - Array code b.
		"""
		# This version is expected to pass.
		arrayfunc.mod(self.inparray1amin, 1, matherrors=True)

		# This is the actual test.
		with self.assertRaises(OverflowError):
			arrayfunc.mod(self.inparray1bmin, -1, matherrors=True)


	########################################################
	def test_mod_array_num_array_b1(self):
		"""Test mod as *array-num-array* for min value % -1 - Array code b.
		"""
		# This version is expected to pass.
		arrayfunc.mod(self.inparray1amin, 1, self.dataout)

		# This is the actual test.
		with self.assertRaises(OverflowError):
			arrayfunc.mod(self.inparray1bmin, -1, self.dataout)


	########################################################
	def test_mod_array_num_array_b2(self):
		"""Test mod as *array-num-array* for min value % -1 matherrors=True - Array code b.
		"""
		# This version is expected to pass.
		arrayfunc.mod(self.inparray1amin, 1, self.dataout, matherrors=True)

		# This is the actual test.
		with self.assertRaises(OverflowError):
			arrayfunc.mod(self.inparray1bmin, -1, self.dataout, matherrors=True)


	########################################################
	def test_mod_num_array_none_c1(self):
		"""Test mod as *num-array-none* for min value % -1 - Array code b.
		"""
		# This version is expected to pass.
	...
	########################################################
	def test_mod_num_array_none_c2(self):
		"""Test mod as *num-array-none* for min value % -1 matherrors=True - Array code b.
		"""
		# This version is expected to pass.
	...
	########################################################
	def test_mod_num_array_array_d1(self):
		"""Test mod as *num-array-array* for min value % -1 - Array code b.
		"""
		# This version is expected to pass.
	...
	########################################################
	def test_mod_num_array_array_d2(self):
		"""Test mod as *num-array-array* for min value % -1 matherrors=True - Array code b.
		"""
		# This version is expected to pass.
	...
	def test_mod_array_num_none_e1(self):
		"""Test mod as *array-array-none* for min value % -1 - Array code b.
		"""
		# This version is expected to pass.
	...
	def test_mod_array_num_none_e2(self):
		"""Test mod as *array-array-none* for min value % -1 matherrors=True - Array code b.
		"""
		# This version is expected to pass.
	...
	def test_mod_array_num_none_f1(self):
		"""Test mod as *array-array-array* for min value % -1 - Array code b.
		"""
		# This version is expected to pass.
	...
	def test_mod_array_num_none_f2(self):
		"""Test mod as *array-array-array* for min value % -1 matherrors=True - Array code b.
		"""
		# This version is expected to pass.
...
class mod_general_B(unittest.TestCase):
	...
	def setUp(self):
		...
		self.datax = [100,101,102,103,104,105,106,107,108,109]
		self.datay = [x for (x,y) in zip(itertools.cycle([1,3,4]), self.datax)]
...
##############################################################################
class mod_general_h(unittest.TestCase):
	"""Test mod for basic general function operation using numeric 
	data -2,-1,1,2.
	test_template_op
	"""
...
class mod_opt_param_errors_h(unittest.TestCase):
	...
	########################################################
	def test_mod_array_num_none_a1(self):
		"""Test mod as *array-num-none* for errors='a' - Array code h.
		"""
		inpvalue = self.inparray2a[0]
	...
	########################################################
	def test_mod_array_num_array_b1(self):
		"""Test mod as *array-num-array* for errors='a' - Array code h.
		"""
		inpvalue = self.inparray2a[0]
	...
	########################################################
	def test_mod_num_array_none_c1(self):
		"""Test mod as *num-array-none* for errors='a' - Array code h.
		"""
		inpvalue = self.inparray1a[0]
	...
	########################################################
	def test_mod_num_array_array_d1(self):
		"""Test mod as *num-array-array* for errors='a' - Array code h.
		"""
		inpvalue = self.inparray1a[0]
	...
	########################################################
	def test_mod_array_array_none_e1(self):
		"""Test mod as *array-array-none* for errors='a' - Array code h.
		"""
	...
	########################################################
	def test_mod_array_array_array_f1(self):
		"""Test mod as *array-array-array* for errors='a' - Array code h.
		"""
		# This version is expected to pass.
		arrayfunc.mod(self.inparray1a, self.inparray2a, self.dataout, matherrors=True)
...
class overflow_signed_mindivminus1_h(unittest.TestCase):
	...
	########################################################
	def test_mod_array_num_none_a1(self):
		"""Test mod as *array-num-none* for min value % -1 - Array code h.
		"""
		# This version is expected to pass.
		arrayfunc.mod(self.inparray1amin, 1)
	...
	########################################################
	def test_mod_array_num_none_a2(self):
		"""Test mod as *array-num-none* for min value % -1 matherrors=True - Array code h.
		"""
		# This version is expected to pass.
		arrayfunc.mod(self.inparray1amin, 1, matherrors=True)
	...
	########################################################
	def test_mod_array_num_array_b1(self):
		"""Test mod as *array-num-array* for min value % -1 - Array code h.
		"""
		# This version is expected to pass.
		arrayfunc.mod(self.inparray1amin, 1, self.dataout)
	...
	########################################################
	def test_mod_array_num_array_b2(self):
		"""Test mod as *array-num-array* for min value % -1 matherrors=True - Array code h.
		"""
		# This version is expected to pass.
		arrayfunc.mod(self.inparray1amin, 1, self.dataout, matherrors=True)
	...
	########################################################
	def test_mod_num_array_none_c1(self):
		"""Test mod as *num-array-none* for min value % -1 - Array code h.
		"""
		# This version is expected to pass.
		arrayfunc.mod(self.MinLimit, self.plus1array)
	...
	########################################################
	def test_mod_num_array_none_c2(self):
		"""Test mod as *num-array-none* for min value % -1 matherrors=True - Array code h.
		"""
		# This version is expected to pass.
		arrayfunc.mod(self.MinLimit, self.plus1array, matherrors=True)
	...
	########################################################
	def test_mod_num_array_array_d1(self):
		"""Test mod as *num-array-array* for min value % -1 - Array code h.
		"""
		# This version is expected to pass.
		arrayfunc.mod(self.MinLimit, self.plus1array, self.dataout)
	...
	########################################################
	def test_mod_num_array_array_d2(self):
		"""Test mod as *num-array-array* for min value % -1 matherrors=True - Array code h.
		"""
		# This version is expected to pass.
		arrayfunc.mod(self.MinLimit, self.plus1array, self.dataout, matherrors=True)
	...
	########################################################
	def test_mod_array_num_none_e1(self):
		"""Test mod as *array-array-none* for min value % -1 - Array code h.
		"""
		# This version is expected to pass.
		arrayfunc.mod(self.inparray1amin, self.plus1array)
	...
	########################################################
	def test_mod_array_num_none_e2(self):
		"""Test mod as *array-array-none* for min value % -1 matherrors=True - Array code h.
		"""
		# This version is expected to pass.
		arrayfunc.mod(self.inparray1amin, self.plus1array, matherrors=True)
	...
	########################################################
	def test_mod_array_num_none_f1(self):
		"""Test mod as *array-array-array* for min value % -1 - Array code h.
		"""
		# This version is expected to pass.
		arrayfunc.mod(self.inparray1amin, self.plus1array, self.dataout)
	...
	########################################################
	def test_mod_array_num_none_f2(self):
		"""Test mod as *array-array-array* for min value % -1 matherrors=True - Array code h.
		"""
		# This version is expected to pass.
		arrayfunc.mod(self.inparray1amin, self.plus1array, self.dataout, matherrors=True)
...
##############################################################################
class mod_general_i(unittest.TestCase):
	"""Test mod for basic general function operation using numeric 
	data -2,-1,1,2.
	test_template_op
	"""
...
class mod_opt_param_errors_i(unittest.TestCase):
	...
	########################################################
	def test_mod_array_num_none_a1(self):
		"""Test mod as *array-num-none* for errors='a' - Array code i.
		"""
		inpvalue = self.inparray2a[0]
	...
	########################################################
	def test_mod_array_num_array_b1(self):
		"""Test mod as *array-num-array* for errors='a' - Array code i.
		"""
		inpvalue = self.inparray2a[0]
	...
	########################################################
	def test_mod_num_array_none_c1(self):
		"""Test mod as *num-array-none* for errors='a' - Array code i.
		"""
		inpvalue = self.inparray1a[0]
	...
	########################################################
	def test_mod_num_array_array_d1(self):
		"""Test mod as *num-array-array* for errors='a' - Array code i.
		"""
		inpvalue = self.inparray1a[0]
	...
	########################################################
	def test_mod_array_array_none_e1(self):
		"""Test mod as *array-array-none* for errors='a' - Array code i.
		"""
	...
	########################################################
	def test_mod_array_array_array_f1(self):
		"""Test mod as *array-array-array* for errors='a' - Array code i.
		"""
		# This version is expected to pass.
		arrayfunc.mod(self.inparray1a, self.inparray2a, self.dataout, matherrors=True)
...
class overflow_signed_mindivminus1_i(unittest.TestCase):
	...
	########################################################
	def test_mod_array_num_none_a1(self):
		"""Test mod as *array-num-none* for min value % -1 - Array code i.
		"""
		# This version is expected to pass.
		arrayfunc.mod(self.inparray1amin, 1)
	...
	########################################################
	def test_mod_array_num_none_a2(self):
		"""Test mod as *array-num-none* for min value % -1 matherrors=True - Array code i.
		"""
		# This version is expected to pass.
		arrayfunc.mod(self.inparray1amin, 1, matherrors=True)
	...
	########################################################
	def test_mod_array_num_array_b1(self):
		"""Test mod as *array-num-array* for min value % -1 - Array code i.
		"""
		# This version is expected to pass.
		arrayfunc.mod(self.inparray1amin, 1, self.dataout)
	...
	########################################################
	def test_mod_array_num_array_b2(self):
		"""Test mod as *array-num-array* for min value % -1 matherrors=True - Array code i.
		"""
		# This version is expected to pass.
		arrayfunc.mod(self.inparray1amin, 1, self.dataout, matherrors=True)
	...
	########################################################
	def test_mod_num_array_none_c1(self):
		"""Test mod as *num-array-none* for min value % -1 - Array code i.
		"""
		# This version is expected to pass.
		arrayfunc.mod(self.MinLimit, self.plus1array)
	...
	########################################################
	def test_mod_num_array_none_c2(self):
		"""Test mod as *num-array-none* for min value % -1 matherrors=True - Array code i.
		"""
		# This version is expected to pass.
		arrayfunc.mod(self.MinLimit, self.plus1array, matherrors=True)
	...
	########################################################
	def test_mod_num_array_array_d1(self):
		"""Test mod as *num-array-array* for min value % -1 - Array code i.
		"""
		# This version is expected to pass.
		arrayfunc.mod(self.MinLimit, self.plus1array, self.dataout)
	...
	########################################################
	def test_mod_num_array_array_d2(self):
		"""Test mod as *num-array-array* for min value % -1 matherrors=True - Array code i.
		"""
		# This version is expected to pass.
		arrayfunc.mod(self.MinLimit, self.plus1array, self.dataout, matherrors=True)
	...
	########################################################
	def test_mod_array_num_none_e1(self):
		"""Test mod as *array-array-none* for min value % -1 - Array code i.
		"""
		# This version is expected to pass.
		arrayfunc.mod(self.inparray1amin, self.plus1array)
	...
	########################################################
	def test_mod_array_num_none_e2(self):
		"""Test mod as *array-array-none* for min value % -1 matherrors=True - Array code i.
		"""
		# This version is expected to pass.
		arrayfunc.mod(self.inparray1amin, self.plus1array, matherrors=True)
	...
	########################################################
	def test_mod_array_num_none_f1(self):
		"""Test mod as *array-array-array* for min value % -1 - Array code i.
		"""
		# This version is expected to pass.
		arrayfunc.mod(self.inparray1amin, self.plus1array, self.dataout)
	...
	########################################################
	def test_mod_array_num_none_f2(self):
		"""Test mod as *array-array-array* for min value % -1 matherrors=True - Array code i.
		"""
		# This version is expected to pass.
		arrayfunc.mod(self.inparray1amin, self.plus1array, self.dataout, matherrors=True)
...
##############################################################################
class mod_general_l(unittest.TestCase):
	"""Test mod for basic general function operation using numeric 
	data -2,-1,1,2.
	test_template_op
	"""
...
class mod_opt_param_errors_l(unittest.TestCase):
	...
	########################################################
	def test_mod_array_num_none_a1(self):
		"""Test mod as *array-num-none* for errors='a' - Array code l.
		"""
		inpvalue = self.inparray2a[0]
	...
	########################################################
	def test_mod_array_num_array_b1(self):
		"""Test mod as *array-num-array* for errors='a' - Array code l.
		"""
		inpvalue = self.inparray2a[0]
	...
	########################################################
	def test_mod_num_array_none_c1(self):
		"""Test mod as *num-array-none* for errors='a' - Array code l.
		"""
		inpvalue = self.inparray1a[0]
	...
	########################################################
	def test_mod_num_array_array_d1(self):
		"""Test mod as *num-array-array* for errors='a' - Array code l.
		"""
		inpvalue = self.inparray1a[0]
	...
	########################################################
	def test_mod_array_array_none_e1(self):
		"""Test mod as *array-array-none* for errors='a' - Array code l.
		"""
	...
	########################################################
	def test_mod_array_array_array_f1(self):
		"""Test mod as *array-array-array* for errors='a' - Array code l.
		"""
		# This version is expected to pass.
		arrayfunc.mod(self.inparray1a, self.inparray2a, self.dataout, matherrors=True)
...
class overflow_signed_mindivminus1_l(unittest.TestCase):
	...
	########################################################
	def test_mod_array_num_none_a1(self):
		"""Test mod as *array-num-none* for min value % -1 - Array code l.
		"""
		# This version is expected to pass.
		arrayfunc.mod(self.inparray1amin, 1)
	...
	########################################################
	def test_mod_array_num_none_a2(self):
		"""Test mod as *array-num-none* for min value % -1 matherrors=True - Array code l.
		"""
		# This version is expected to pass.
		arrayfunc.mod(self.inparray1amin, 1, matherrors=True)
	...
	########################################################
	def test_mod_array_num_array_b1(self):
		"""Test mod as *array-num-array* for min value % -1 - Array code l.
		"""
		# This version is expected to pass.
		arrayfunc.mod(self.inparray1amin, 1, self.dataout)
	...
	########################################################
	def test_mod_array_num_array_b2(self):
		"""Test mod as *array-num-array* for min value % -1 matherrors=True - Array code l.
		"""
		# This version is expected to pass.
		arrayfunc.mod(self.inparray1amin, 1, self.dataout, matherrors=True)
	...
	########################################################
	def test_mod_num_array_none_c1(self):
		"""Test mod as *num-array-none* for min value % -1 - Array code l.
		"""
		# This version is expected to pass.
		arrayfunc.mod(self.MinLimit, self.plus1array)
	...
	########################################################
	def test_mod_num_array_none_c2(self):
		"""Test mod as *num-array-none* for min value % -1 matherrors=True - Array code l.
		"""
		# This version is expected to pass.
		arrayfunc.mod(self.MinLimit, self.plus1array, matherrors=True)
	...
	########################################################
	def test_mod_num_array_array_d1(self):
		"""Test mod as *num-array-array* for min value % -1 - Array code l.
		"""
		# This version is expected to pass.
		arrayfunc.mod(self.MinLimit, self.plus1array, self.dataout)
	...
	########################################################
	def test_mod_num_array_array_d2(self):
		"""Test mod as *num-array-array* for min value % -1 matherrors=True - Array code l.
		"""
		# This version is expected to pass.
		arrayfunc.mod(self.MinLimit, self.plus1array, self.dataout, matherrors=True)
	...
	########################################################
	def test_mod_array_num_none_e1(self):
		"""Test mod as *array-array-none* for min value % -1 - Array code l.
		"""
		# This version is expected to pass.
		arrayfunc.mod(self.inparray1amin, self.plus1array)
	...
	########################################################
	def test_mod_array_num_none_e2(self):
		"""Test mod as *array-array-none* for min value % -1 matherrors=True - Array code l.
		"""
		# This version is expected to pass.
		arrayfunc.mod(self.inparray1amin, self.plus1array, matherrors=True)
	...
	########################################################
	def test_mod_array_num_none_f1(self):
		"""Test mod as *array-array-array* for min value % -1 - Array code l.
		"""
		# This version is expected to pass.
		arrayfunc.mod(self.inparray1amin, self.plus1array, self.dataout)
	...
	########################################################
	def test_mod_array_num_none_f2(self):
		"""Test mod as *array-array-array* for min value % -1 matherrors=True - Array code l.
		"""
		# This version is expected to pass.
		arrayfunc.mod(self.inparray1amin, self.plus1array, self.dataout, matherrors=True)
...
##############################################################################
class mod_general_q(unittest.TestCase):
	"""Test mod for basic general function operation using numeric 
	data -2,-1,1,2.
	test_template_op
	"""
...
class mod_opt_param_errors_q(unittest.TestCase):
	...
	########################################################
	def test_mod_array_num_none_a1(self):
		"""Test mod as *array-num-none* for errors='a' - Array code q.
		"""
		inpvalue = self.inparray2a[0]
	...
	########################################################
	def test_mod_array_num_array_b1(self):
		"""Test mod as *array-num-array* for errors='a' - Array code q.
		"""
		inpvalue = self.inparray2a[0]
	...
	########################################################
	def test_mod_num_array_none_c1(self):
		"""Test mod as *num-array-none* for errors='a' - Array code q.
		"""
		inpvalue = self.inparray1a[0]
	...
	########################################################
	def test_mod_num_array_array_d1(self):
		"""Test mod as *num-array-array* for errors='a' - Array code q.
		"""
		inpvalue = self.inparray1a[0]
	...
	########################################################
	def test_mod_array_array_none_e1(self):
		"""Test mod as *array-array-none* for errors='a' - Array code q.
		"""
	...
	########################################################
	def test_mod_array_array_array_f1(self):
		"""Test mod as *array-array-array* for errors='a' - Array code q.
		"""
		# This version is expected to pass.
		arrayfunc.mod(self.inparray1a, self.inparray2a, self.dataout, matherrors=True)
...
class overflow_signed_mindivminus1_q(unittest.TestCase):
	...
	########################################################
	def test_mod_array_num_none_a1(self):
		"""Test mod as *array-num-none* for min value % -1 - Array code q.
		"""
		# This version is expected to pass.
		arrayfunc.mod(self.inparray1amin, 1)
	...
	########################################################
	def test_mod_array_num_none_a2(self):
		"""Test mod as *array-num-none* for min value % -1 matherrors=True - Array code q.
		"""
		# This version is expected to pass.
		arrayfunc.mod(self.inparray1amin, 1, matherrors=True)
	...
	########################################################
	def test_mod_array_num_array_b1(self):
		"""Test mod as *array-num-array* for min value % -1 - Array code q.
		"""
		# This version is expected to pass.
		arrayfunc.mod(self.inparray1amin, 1, self.dataout)
	...
	########################################################
	def test_mod_array_num_array_b2(self):
		"""Test mod as *array-num-array* for min value % -1 matherrors=True - Array code q.
		"""
		# This version is expected to pass.
		arrayfunc.mod(self.inparray1amin, 1, self.dataout, matherrors=True)
	...
	########################################################
	def test_mod_num_array_none_c1(self):
		"""Test mod as *num-array-none* for min value % -1 - Array code q.
		"""
		# This version is expected to pass.
		arrayfunc.mod(self.MinLimit, self.plus1array)
	...
	########################################################
	def test_mod_num_array_none_c2(self):
		"""Test mod as *num-array-none* for min value % -1 matherrors=True - Array code q.
		"""
		# This version is expected to pass.
		arrayfunc.mod(self.MinLimit, self.plus1array, matherrors=True)
	...
	########################################################
	def test_mod_num_array_array_d1(self):
		"""Test mod as *num-array-array* for min value % -1 - Array code q.
		"""
		# This version is expected to pass.
		arrayfunc.mod(self.MinLimit, self.plus1array, self.dataout)
	...
	########################################################
	def test_mod_num_array_array_d2(self):
		"""Test mod as *num-array-array* for min value % -1 matherrors=True - Array code q.
		"""
		# This version is expected to pass.
		arrayfunc.mod(self.MinLimit, self.plus1array, self.dataout, matherrors=True)
	...
	########################################################
	def test_mod_array_num_none_e1(self):
		"""Test mod as *array-array-none* for min value % -1 - Array code q.
		"""
		# This version is expected to pass.
		arrayfunc.mod(self.inparray1amin, self.plus1array)
	...
	########################################################
	def test_mod_array_num_none_e2(self):
		"""Test mod as *array-array-none* for min value % -1 matherrors=True - Array code q.
		"""
		# This version is expected to pass.
		arrayfunc.mod(self.inparray1amin, self.plus1array, matherrors=True)
	...
	########################################################
	def test_mod_array_num_none_f1(self):
		"""Test mod as *array-array-array* for min value % -1 - Array code q.
		"""
		# This version is expected to pass.
		arrayfunc.mod(self.inparray1amin, self.plus1array, self.dataout)
	...
	########################################################
	def test_mod_array_num_none_f2(self):
		"""Test mod as *array-array-array* for min value % -1 matherrors=True - Array code q.
		"""
		# This version is expected to pass.
		arrayfunc.mod(self.inparray1amin, self.plus1array, self.dataout, matherrors=True)
...
##############################################################################
class mod_general_f(unittest.TestCase):
	"""Test mod for basic general function operation using numeric 
	...
	def setUp(self):
		...
		self.datay = [x for (x,y) in zip(itertools.cycle([-2.0,-1.0,1.0,2.0]), self.datax)]
...
class mod_opt_param_errors_f(unittest.TestCase):
	...
	########################################################
	def test_mod_array_num_none_a1(self):
		"""Test mod as *array-num-none* for errors='a' - Array code f.
		"""
		inpvalue = self.inparray2a[0]
	...
	########################################################
	def test_mod_array_num_array_b1(self):
		"""Test mod as *array-num-array* for errors='a' - Array code f.
		"""
		inpvalue = self.inparray2a[0]
	...
	########################################################
	def test_mod_num_array_none_c1(self):
		"""Test mod as *num-array-none* for errors='a' - Array code f.
		"""
		inpvalue = self.inparray1a[0]
	...
	########################################################
	def test_mod_num_array_array_d1(self):
		"""Test mod as *num-array-array* for errors='a' - Array code f.
		"""
		inpvalue = self.inparray1a[0]
	...
	########################################################
	def test_mod_array_array_none_e1(self):
		"""Test mod as *array-array-none* for errors='a' - Array code f.
		"""
	...
	########################################################
	def test_mod_array_array_array_f1(self):
		"""Test mod as *array-array-array* for errors='a' - Array code f.
		"""
		# This version is expected to pass.
		arrayfunc.mod(self.inparray1a, self.inparray2a, self.dataout, matherrors=True)
	...
	def test_mod_inf_num_array_none_c2(self):
		...
		for testval in [100.0,101.0,102.0,103.0,104.0,105.0,106.0,107.0,108.0,109.0]:
			with self.subTest(msg='Failed with parameter', testval = testval):
				...
				expected = [float('nan')] * len(self.errordata)
...
##############################################################################
class mod_general_d(unittest.TestCase):
	"""Test mod for basic general function operation using numeric 
	data -2.0,-1.0,1.0,2.0.
	test_template_op
	"""
...
class mod_opt_param_errors_d(unittest.TestCase):
	...
	########################################################
	def test_mod_array_num_none_a1(self):
		"""Test mod as *array-num-none* for errors='a' - Array code d.
		"""
		inpvalue = self.inparray2a[0]
	...
	########################################################
	def test_mod_array_num_array_b1(self):
		"""Test mod as *array-num-array* for errors='a' - Array code d.
		"""
		inpvalue = self.inparray2a[0]
	...
	########################################################
	def test_mod_num_array_none_c1(self):
		"""Test mod as *num-array-none* for errors='a' - Array code d.
		"""
		inpvalue = self.inparray1a[0]
	...
	########################################################
	def test_mod_num_array_array_d1(self):
		"""Test mod as *num-array-array* for errors='a' - Array code d.
		"""
		inpvalue = self.inparray1a[0]
	...
	########################################################
	def test_mod_array_array_none_e1(self):
		"""Test mod as *array-array-none* for errors='a' - Array code d.
		"""
	...
	########################################################
	def test_mod_array_array_array_f1(self):
		"""Test mod as *array-array-array* for errors='a' - Array code d.
		"""
		# This version is expected to pass.
		arrayfunc.mod(self.inparray1a, self.inparray2a, self.dataout, matherrors=True)

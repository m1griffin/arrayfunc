...
class afilter_operator_b(unittest.TestCase):
	...
	########################################################
	def PyFilter(self, op, data, param, maxlen=0):
		...
		result = list(filter(opval, testdata))
	...
	def test_operator_eq_01(self):
		...
		"""
		param = 97
		result = arrayfunc.afilter('==', self.data, self.dataout, param)
		expected, explength = self.PyFilter('==', self.data, param)
	...
	def test_operator_lim_01(self):
		...
		"""
		param = 97
		result = arrayfunc.afilter('==', self.data, self.dataout, param, maxlen=len(self.data)//2)
		expected, explength = self.PyFilter('==', self.data, param, maxlen=len(self.data)//2)
	...
	def test_operator_lim_02(self):
		...
		"""
		param = 97
		result = arrayfunc.afilter('==', self.data, self.dataout, param, maxlen=-1)
		expected, explength = self.PyFilter('==', self.data, param, maxlen=-1)
...
##############################################################################
class afilter_params_b(unittest.TestCase):
	...
	def test_param_six_params(self):
		...
		param = 101
		with self.assertRaises(TypeError):
			result = arrayfunc.afilter('==', self.data, self.dataout, param, 3, maxlen=2)
...
##############################################################################
class afilter_paramovfl_b(unittest.TestCase):
	...
	def test_overflow_min(self):
		...
		with self.assertRaises(OverflowError):
			result = arrayfunc.afilter('==', self.dataovfl, self.dataoutovfl, self.MinVal - 1)
	...
	def test_overflow_max(self):
		...
		"""
		with self.assertRaises(OverflowError):
			result = arrayfunc.afilter('==', self.dataovfl, self.dataoutovfl, self.Maxval + 1)
	...
	def test_overflow_ok(self):
		...
		"""
		result = arrayfunc.afilter('==', self.dataovfl, self.dataoutovfl, self.MinVal)
		result = arrayfunc.afilter('==', self.dataovfl, self.dataoutovfl, self.Maxval)
...
##############################################################################
class afilter_params_h(unittest.TestCase):
	"""Test for basic parameter function.
	"""
...
##############################################################################
class afilter_paramovfl_h(unittest.TestCase):
	"""Test for testing parameter overflow.
	"""
...
##############################################################################
class afilter_params_i(unittest.TestCase):
	"""Test for basic parameter function.
	"""
...
##############################################################################
class afilter_paramovfl_i(unittest.TestCase):
	"""Test for testing parameter overflow.
	"""
...
##############################################################################
class afilter_params_l(unittest.TestCase):
	"""Test for basic parameter function.
	"""
...
##############################################################################
class afilter_paramovfl_l(unittest.TestCase):
	"""Test for testing parameter overflow.
	"""
...
##############################################################################
class afilter_params_q(unittest.TestCase):
	"""Test for basic parameter function.
	"""
...
##############################################################################
class afilter_paramovfl_q(unittest.TestCase):
	"""Test for testing parameter overflow.
	"""
...
##############################################################################
class afilter_params_f(unittest.TestCase):
	"""Test for basic parameter function.
	"""
...
##############################################################################
class afilter_paramovfl_f(unittest.TestCase):
	"""Test for testing parameter overflow.
	"""
	...
	def test_overflow_min(self):
		...
		"""
		with self.assertRaises(OverflowError):
			result = arrayfunc.afilter('==', self.dataovfl, self.dataoutovfl, self.MinVal * 1.1)
	...
	def test_overflow_max(self):
		...
		"""
		with self.assertRaises(OverflowError):
			result = arrayfunc.afilter('==', self.dataovfl, self.dataoutovfl, self.Maxval * 1.1)
...
##############################################################################
class afilter_params_d(unittest.TestCase):
	"""Test for basic parameter function.
	"""
...
##############################################################################
class afilter_nonfinite_f(unittest.TestCase):
	...
	def test_nonfinite_04(self):
		...
		"""
		with self.assertRaises(TypeError):
			result = arrayfunc.afilter('==', self.data, self.dataout, 100.0, maxlen=math.nan)
	...
	def test_nonfinite_05(self):
		...
		"""
		with self.assertRaises(TypeError):
			result = arrayfunc.afilter('==', self.data, self.dataout, 100.0, maxlen=math.inf)
...
##############################################################################
class afilter_nonfinite_d(unittest.TestCase):
	"""Test for nan, inf, -inf.
	"""

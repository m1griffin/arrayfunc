...
char add_double_1_simd_ovfl(Py_ssize_t arraylen, double *data1, double param);
char add_double_2_simd_ovfl(Py_ssize_t arraylen, double *data1, double param, double *data3);
char add_double_3_simd_ovfl(Py_ssize_t arraylen, double param, double *data2);
char add_double_4_simd_ovfl(Py_ssize_t arraylen, double param, double *data2, double *data3);
char add_double_5_simd_ovfl(Py_ssize_t arraylen, double *data1, double *data2);
char add_double_6_simd_ovfl(Py_ssize_t arraylen, double *data1, double *data2, double *data3);

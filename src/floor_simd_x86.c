...
void floor_float_1_simd(Py_ssize_t arraylen, float *data) {
...
// param_arr_arr
void floor_float_2_simd(Py_ssize_t arraylen, float *data, float *dataout) {
...
// param_arr_none
#if defined(AF_HASSIMD_X86)
void floor_double_1_simd(Py_ssize_t arraylen, double *data) {
...
// param_arr_arr
void floor_double_2_simd(Py_ssize_t arraylen, double *data, double *dataout) {

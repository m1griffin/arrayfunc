//------------------------------------------------------------------------------
// Project:  arrayfunc
// Module:   arrayparams_droptakefilter.c
...
static char *kwlist_droptakefilter[] = {"op", "data", "dataout", "param", "maxlen", NULL};
...
struct args_params_droptakefilter getparams_droptakefilter(PyObject *self, PyObject *args, PyObject *keywds, char *funcname) {
	...
	if (!PyArg_ParseTupleAndKeywords(args, keywds, formatstr, kwlist_droptakefilter, &opstr, 

...
#include "sub_simd_armv7.h"
#endif

#if defined(AF_HASSIMD_ARM_AARCH64)
#include "sub_simd_armv8.h"
#endif
...
signed int sub_signed_char_1(Py_ssize_t arraylen, int nosimd, signed char *data1, signed char param, unsigned int ignoreerrors) {
	...
	if (!nosimd && enoughforsimd(arraylen, CHARSIMDSIZE)) {
		...
		// Math error checking enabled.
			ovflresult = sub_signed_char_1_simd_ovfl(arraylen, data1, param);
...
signed int sub_signed_char_2(Py_ssize_t arraylen, int nosimd, signed char *data1, signed char param, signed char *data3, unsigned int ignoreerrors) {
	...
	if (!nosimd && enoughforsimd(arraylen, CHARSIMDSIZE)) {
		...
		// Math error checking enabled.
			ovflresult = sub_signed_char_2_simd_ovfl(arraylen, data1, param, data3);
			if (ovflresult) { return ARR_ERR_OVFL; }
		}
...
signed int sub_signed_char_3(Py_ssize_t arraylen, int nosimd, signed char param, signed char *data2, unsigned int ignoreerrors) {
	...
	if (!nosimd && enoughforsimd(arraylen, CHARSIMDSIZE)) {
		...
		// Math error checking enabled.
			ovflresult = sub_signed_char_3_simd_ovfl(arraylen, param, data2);
			if (ovflresult) { return ARR_ERR_OVFL; }
		}
...
signed int sub_signed_char_4(Py_ssize_t arraylen, int nosimd, signed char param, signed char *data2, signed char *data3, unsigned int ignoreerrors) {
	...
	if (!nosimd && enoughforsimd(arraylen, CHARSIMDSIZE)) {
		...
		// Math error checking enabled.
			ovflresult = sub_signed_char_4_simd_ovfl(arraylen, param, data2, data3);
			if (ovflresult) { return ARR_ERR_OVFL; }
		}
...
signed int sub_unsigned_char_1(Py_ssize_t arraylen, int nosimd, unsigned char *data1, unsigned char param, unsigned int ignoreerrors) {
	...
	if (!nosimd && enoughforsimd(arraylen, CHARSIMDSIZE)) {
		...
		// Math error checking enabled.
			ovflresult = sub_unsigned_char_1_simd_ovfl(arraylen, data1, param);
			if (ovflresult) { return ARR_ERR_OVFL; }
		}
		...
		// Math error checking enabled.
			for (x = 0; x < arraylen; x++) {
				if ( loop_willoverflow_unsigned_char(data1[x], param) ) {return ARR_ERR_OVFL;}
				data1[x] = data1[x] - param;
			}
		}
...
signed int sub_unsigned_char_2(Py_ssize_t arraylen, int nosimd, unsigned char *data1, unsigned char param, unsigned char *data3, unsigned int ignoreerrors) {
	...
	if (!nosimd && enoughforsimd(arraylen, CHARSIMDSIZE)) {
		...
		// Math error checking enabled.
			ovflresult = sub_unsigned_char_2_simd_ovfl(arraylen, data1, param, data3);
			if (ovflresult) { return ARR_ERR_OVFL; }
		}
...
signed int sub_unsigned_char_3(Py_ssize_t arraylen, int nosimd, unsigned char param, unsigned char *data2, unsigned int ignoreerrors) {
	...
	if (!nosimd && enoughforsimd(arraylen, CHARSIMDSIZE)) {
		...
		// Math error checking enabled.
			ovflresult = sub_unsigned_char_3_simd_ovfl(arraylen, param, data2);
			if (ovflresult) { return ARR_ERR_OVFL; }
		}
		...
		// Math error checking enabled.
			for (x = 0; x < arraylen; x++) {
				if ( loop_willoverflow_unsigned_char(param, data2[x]) ) {return ARR_ERR_OVFL;}
				data2[x] = param - data2[x];
			}
		}
...
signed int sub_unsigned_char_4(Py_ssize_t arraylen, int nosimd, unsigned char param, unsigned char *data2, unsigned char *data3, unsigned int ignoreerrors) {
	...
	if (!nosimd && enoughforsimd(arraylen, CHARSIMDSIZE)) {
		...
		// Math error checking enabled.
			ovflresult = sub_unsigned_char_4_simd_ovfl(arraylen, param, data2, data3);
			if (ovflresult) { return ARR_ERR_OVFL; }
		}
...
signed int sub_unsigned_char_5(Py_ssize_t arraylen, int nosimd, unsigned char *data1, unsigned char *data2, unsigned int ignoreerrors) {
	...
	if (!nosimd && enoughforsimd(arraylen, CHARSIMDSIZE)) {
		...
		// Math error checking enabled.
			ovflresult = sub_unsigned_char_5_simd_ovfl(arraylen, data1, data2);
			if (ovflresult) { return ARR_ERR_OVFL; }
		}
		...
		// Math error checking enabled.
			for (x = 0; x < arraylen; x++) {
				if ( loop_willoverflow_unsigned_char(data1[x], data2[x]) ) {return ARR_ERR_OVFL;}
				data1[x] = data1[x] - data2[x];
			}
		}
...
signed int sub_unsigned_char_6(Py_ssize_t arraylen, int nosimd, unsigned char *data1, unsigned char *data2, unsigned char *data3, unsigned int ignoreerrors) {
	...
	if (!nosimd && enoughforsimd(arraylen, CHARSIMDSIZE)) {
		...
		// Math error checking enabled.
			ovflresult = sub_unsigned_char_6_simd_ovfl(arraylen, data1, data2, data3);
			if (ovflresult) { return ARR_ERR_OVFL; }
		}
...
signed int sub_signed_short_1(Py_ssize_t arraylen, int nosimd, signed short *data1, signed short param, unsigned int ignoreerrors) {
	...
	if (!nosimd && enoughforsimd(arraylen, SHORTSIMDSIZE)) {
		...
		// Math error checking enabled.
			ovflresult = sub_signed_short_1_simd_ovfl(arraylen, data1, param);
			if (ovflresult) { return ARR_ERR_OVFL; }
		}
...
signed int sub_signed_short_2(Py_ssize_t arraylen, int nosimd, signed short *data1, signed short param, signed short *data3, unsigned int ignoreerrors) {
	...
	if (!nosimd && enoughforsimd(arraylen, SHORTSIMDSIZE)) {
		...
		// Math error checking enabled.
			ovflresult = sub_signed_short_2_simd_ovfl(arraylen, data1, param, data3);
			if (ovflresult) { return ARR_ERR_OVFL; }
		}
...
signed int sub_signed_short_3(Py_ssize_t arraylen, int nosimd, signed short param, signed short *data2, unsigned int ignoreerrors) {
	...
	if (!nosimd && enoughforsimd(arraylen, SHORTSIMDSIZE)) {
		...
		// Math error checking enabled.
			ovflresult = sub_signed_short_3_simd_ovfl(arraylen, param, data2);
			if (ovflresult) { return ARR_ERR_OVFL; }
		}
...
signed int sub_signed_short_4(Py_ssize_t arraylen, int nosimd, signed short param, signed short *data2, signed short *data3, unsigned int ignoreerrors) {
	...
	if (!nosimd && enoughforsimd(arraylen, SHORTSIMDSIZE)) {
		...
		// Math error checking enabled.
			ovflresult = sub_signed_short_4_simd_ovfl(arraylen, param, data2, data3);
			if (ovflresult) { return ARR_ERR_OVFL; }
		}
...
signed int sub_unsigned_short_1(Py_ssize_t arraylen, int nosimd, unsigned short *data1, unsigned short param, unsigned int ignoreerrors) {
	...
	if (!nosimd && enoughforsimd(arraylen, SHORTSIMDSIZE)) {
		...
		// Math error checking enabled.
			ovflresult = sub_unsigned_short_1_simd_ovfl(arraylen, data1, param);
			if (ovflresult) { return ARR_ERR_OVFL; }
		}
		...
		// Math error checking enabled.
			for (x = 0; x < arraylen; x++) {
				if ( loop_willoverflow_unsigned_short(data1[x], param) ) {return ARR_ERR_OVFL;}
				data1[x] = data1[x] - param;
			}
		}
...
signed int sub_unsigned_short_2(Py_ssize_t arraylen, int nosimd, unsigned short *data1, unsigned short param, unsigned short *data3, unsigned int ignoreerrors) {
	...
	if (!nosimd && enoughforsimd(arraylen, SHORTSIMDSIZE)) {
		...
		// Math error checking enabled.
			ovflresult = sub_unsigned_short_2_simd_ovfl(arraylen, data1, param, data3);
			if (ovflresult) { return ARR_ERR_OVFL; }
		}
...
signed int sub_unsigned_short_3(Py_ssize_t arraylen, int nosimd, unsigned short param, unsigned short *data2, unsigned int ignoreerrors) {
	...
	if (!nosimd && enoughforsimd(arraylen, SHORTSIMDSIZE)) {
		...
		// Math error checking enabled.
			ovflresult = sub_unsigned_short_3_simd_ovfl(arraylen, param, data2);
			if (ovflresult) { return ARR_ERR_OVFL; }
		}
		...
		// Math error checking enabled.
			for (x = 0; x < arraylen; x++) {
				if ( loop_willoverflow_unsigned_short(param, data2[x]) ) {return ARR_ERR_OVFL;}
				data2[x] = param - data2[x];
			}
		}
...
signed int sub_unsigned_short_4(Py_ssize_t arraylen, int nosimd, unsigned short param, unsigned short *data2, unsigned short *data3, unsigned int ignoreerrors) {
	...
	if (!nosimd && enoughforsimd(arraylen, SHORTSIMDSIZE)) {
		...
		// Math error checking enabled.
			ovflresult = sub_unsigned_short_4_simd_ovfl(arraylen, param, data2, data3);
			if (ovflresult) { return ARR_ERR_OVFL; }
		}
...
signed int sub_unsigned_short_5(Py_ssize_t arraylen, int nosimd, unsigned short *data1, unsigned short *data2, unsigned int ignoreerrors) {
	...
	if (!nosimd && enoughforsimd(arraylen, SHORTSIMDSIZE)) {
		...
		// Math error checking enabled.
			ovflresult = sub_unsigned_short_5_simd_ovfl(arraylen, data1, data2);
			if (ovflresult) { return ARR_ERR_OVFL; }
		}
		...
		// Math error checking enabled.
			for (x = 0; x < arraylen; x++) {
				if ( loop_willoverflow_unsigned_short(data1[x], data2[x]) ) {return ARR_ERR_OVFL;}
				data1[x] = data1[x] - data2[x];
			}
		}
...
signed int sub_unsigned_short_6(Py_ssize_t arraylen, int nosimd, unsigned short *data1, unsigned short *data2, unsigned short *data3, unsigned int ignoreerrors) {
	...
	if (!nosimd && enoughforsimd(arraylen, SHORTSIMDSIZE)) {
		...
		// Math error checking enabled.
			ovflresult = sub_unsigned_short_6_simd_ovfl(arraylen, data1, data2, data3);
			if (ovflresult) { return ARR_ERR_OVFL; }
		}
...
signed int sub_signed_int_1(Py_ssize_t arraylen, int nosimd, signed int *data1, signed int param, unsigned int ignoreerrors) {
	...
	if (!nosimd && enoughforsimd(arraylen, INTSIMDSIZE)) {
		...
		// Math error checking enabled.
			ovflresult = sub_signed_int_1_simd_ovfl(arraylen, data1, param);
			if (ovflresult) { return ARR_ERR_OVFL; }
		}
		...
		// Math error checking enabled.
			...
			if (param > 0) {
				ovlimit = pos_ovlimit_12_signed_int(param);
				for (x = 0; x < arraylen; x++) {
					if ( pos_willoverflow(data1[x], ovlimit) ) {return ARR_ERR_OVFL;}
					data1[x] = data1[x] - param; 
				}
			...
			if (param < 0) {
				ovlimit = neg_ovlimit_12_signed_int(param);
				for (x = 0; x < arraylen; x++) {
					if ( neg_willoverflow(data1[x], ovlimit) ) {return ARR_ERR_OVFL;}
					data1[x] = data1[x] - param; 
				}
...
signed int sub_signed_int_2(Py_ssize_t arraylen, int nosimd, signed int *data1, signed int param, signed int *data3, unsigned int ignoreerrors) {
	...
	if (!nosimd && enoughforsimd(arraylen, INTSIMDSIZE)) {
		...
		// Math error checking enabled.
			ovflresult = sub_signed_int_2_simd_ovfl(arraylen, data1, param, data3);
			if (ovflresult) { return ARR_ERR_OVFL; }
		}
...
signed int sub_signed_int_3(Py_ssize_t arraylen, int nosimd, signed int param, signed int *data2, unsigned int ignoreerrors) {
	...
	if (!nosimd && enoughforsimd(arraylen, INTSIMDSIZE)) {
		...
		// Math error checking enabled.
			ovflresult = sub_signed_int_3_simd_ovfl(arraylen, param, data2);
			if (ovflresult) { return ARR_ERR_OVFL; }
		}
		...
		// Math error checking enabled.
			...
			if (param > 0) {
				ovlimit = pos_ovlimit_34_signed_int(param);
				for (x = 0; x < arraylen; x++) {
					if ( pos_willoverflow(data2[x], ovlimit) ) {return ARR_ERR_OVFL;}
					data2[x] = param - data2[x]; 
				}
			...
			if (param < 0) {
				ovlimit = neg_ovlimit_34_signed_int(param);
				for (x = 0; x < arraylen; x++) {
					if ( neg_willoverflow(data2[x], ovlimit) ) {return ARR_ERR_OVFL;}
					data2[x] = param - data2[x]; 
				}
...
signed int sub_signed_int_4(Py_ssize_t arraylen, int nosimd, signed int param, signed int *data2, signed int *data3, unsigned int ignoreerrors) {
	...
	if (!nosimd && enoughforsimd(arraylen, INTSIMDSIZE)) {
		...
		// Math error checking enabled.
			ovflresult = sub_signed_int_4_simd_ovfl(arraylen, param, data2, data3);
			if (ovflresult) { return ARR_ERR_OVFL; }
		}
...
signed int sub_unsigned_int_1(Py_ssize_t arraylen, int nosimd, unsigned int *data1, unsigned int param, unsigned int ignoreerrors) {
	...
	if (!nosimd && enoughforsimd(arraylen, INTSIMDSIZE)) {
		...
		// Math error checking enabled.
			ovflresult = sub_unsigned_int_1_simd_ovfl(arraylen, data1, param);
			if (ovflresult) { return ARR_ERR_OVFL; }
		}
		...
		// Math error checking enabled.
			for (x = 0; x < arraylen; x++) {
				if ( loop_willoverflow_unsigned_int(data1[x], param) ) {return ARR_ERR_OVFL;}
				data1[x] = data1[x] - param;
			}
		}
...
signed int sub_unsigned_int_2(Py_ssize_t arraylen, int nosimd, unsigned int *data1, unsigned int param, unsigned int *data3, unsigned int ignoreerrors) {
	...
	if (!nosimd && enoughforsimd(arraylen, INTSIMDSIZE)) {
		...
		// Math error checking enabled.
			ovflresult = sub_unsigned_int_2_simd_ovfl(arraylen, data1, param, data3);
			if (ovflresult) { return ARR_ERR_OVFL; }
		}
...
signed int sub_unsigned_int_3(Py_ssize_t arraylen, int nosimd, unsigned int param, unsigned int *data2, unsigned int ignoreerrors) {
	...
	if (!nosimd && enoughforsimd(arraylen, INTSIMDSIZE)) {
		...
		// Math error checking enabled.
			ovflresult = sub_unsigned_int_3_simd_ovfl(arraylen, param, data2);
			if (ovflresult) { return ARR_ERR_OVFL; }
		}
		...
		// Math error checking enabled.
			for (x = 0; x < arraylen; x++) {
				if ( loop_willoverflow_unsigned_int(param, data2[x]) ) {return ARR_ERR_OVFL;}
				data2[x] = param - data2[x];
			}
		}
...
signed int sub_unsigned_int_4(Py_ssize_t arraylen, int nosimd, unsigned int param, unsigned int *data2, unsigned int *data3, unsigned int ignoreerrors) {
	...
	if (!nosimd && enoughforsimd(arraylen, INTSIMDSIZE)) {
		...
		// Math error checking enabled.
			ovflresult = sub_unsigned_int_4_simd_ovfl(arraylen, param, data2, data3);
			if (ovflresult) { return ARR_ERR_OVFL; }
		}
...
signed int sub_unsigned_int_5(Py_ssize_t arraylen, int nosimd, unsigned int *data1, unsigned int *data2, unsigned int ignoreerrors) {
	...
	if (!nosimd && enoughforsimd(arraylen, INTSIMDSIZE)) {
		...
		// Math error checking enabled.
			ovflresult = sub_unsigned_int_5_simd_ovfl(arraylen, data1, data2);
			if (ovflresult) { return ARR_ERR_OVFL; }
		}
		...
		// Math error checking enabled.
			for (x = 0; x < arraylen; x++) {
				if ( loop_willoverflow_unsigned_int(data1[x], data2[x]) ) {return ARR_ERR_OVFL;}
				data1[x] = data1[x] - data2[x];
			}
		}
...
signed int sub_unsigned_int_6(Py_ssize_t arraylen, int nosimd, unsigned int *data1, unsigned int *data2, unsigned int *data3, unsigned int ignoreerrors) {
	...
	if (!nosimd && enoughforsimd(arraylen, INTSIMDSIZE)) {
		...
		// Math error checking enabled.
			ovflresult = sub_unsigned_int_6_simd_ovfl(arraylen, data1, data2, data3);
			if (ovflresult) { return ARR_ERR_OVFL; }
		}
...
*/
// param_arr_num_none
signed int sub_signed_long_1(Py_ssize_t arraylen, signed long *data1, signed long param, unsigned int ignoreerrors) {
	...
	signed long ovlimit;
		...
		// Math error checking enabled.
			...
			if (param > 0) {
				ovlimit = pos_ovlimit_12_signed_long(param);
				for (x = 0; x < arraylen; x++) {
					if ( pos_willoverflow(data1[x], ovlimit) ) {return ARR_ERR_OVFL;}
					data1[x] = data1[x] - param; 
				}
			...
			if (param < 0) {
				ovlimit = neg_ovlimit_12_signed_long(param);
				for (x = 0; x < arraylen; x++) {
					if ( neg_willoverflow(data1[x], ovlimit) ) {return ARR_ERR_OVFL;}
					data1[x] = data1[x] - param; 
				}
...
// param_arr_num_arr
signed int sub_signed_long_2(Py_ssize_t arraylen, signed long *data1, signed long param, signed long *data3, unsigned int ignoreerrors) {
...
// param_num_arr_none
signed int sub_signed_long_3(Py_ssize_t arraylen, signed long param, signed long *data2, unsigned int ignoreerrors) {
	...
	signed long ovlimit;
		...
		// Math error checking enabled.
			...
			if (param > 0) {
				ovlimit = pos_ovlimit_34_signed_long(param);
				for (x = 0; x < arraylen; x++) {
					if ( pos_willoverflow(data2[x], ovlimit) ) {return ARR_ERR_OVFL;}
					data2[x] = param - data2[x]; 
				}
			...
			if (param < 0) {
				ovlimit = neg_ovlimit_34_signed_long(param);
				for (x = 0; x < arraylen; x++) {
					if ( neg_willoverflow(data2[x], ovlimit) ) {return ARR_ERR_OVFL;}
					data2[x] = param - data2[x]; 
				}
...
// param_num_arr_arr
signed int sub_signed_long_4(Py_ssize_t arraylen, signed long param, signed long *data2, signed long *data3, unsigned int ignoreerrors) {
...
// param_arr_arr_none
signed int sub_signed_long_5(Py_ssize_t arraylen, signed long *data1, signed long *data2, unsigned int ignoreerrors) {
...
// param_arr_arr_arr
signed int sub_signed_long_6(Py_ssize_t arraylen, signed long *data1, signed long *data2, signed long *data3, unsigned int ignoreerrors) {
...
*/
// param_arr_num_none
signed int sub_unsigned_long_1(Py_ssize_t arraylen, unsigned long *data1, unsigned long param, unsigned int ignoreerrors) {
	...
	Py_ssize_t x;
		...
		// Math error checking enabled.
			for (x = 0; x < arraylen; x++) {
				if ( loop_willoverflow_unsigned_long(data1[x], param) ) {return ARR_ERR_OVFL;}
				data1[x] = data1[x] - param;
			}
		}
...
// param_arr_num_arr
signed int sub_unsigned_long_2(Py_ssize_t arraylen, unsigned long *data1, unsigned long param, unsigned long *data3, unsigned int ignoreerrors) {
...
// param_num_arr_none
signed int sub_unsigned_long_3(Py_ssize_t arraylen, unsigned long param, unsigned long *data2, unsigned int ignoreerrors) {
	...
	Py_ssize_t x;
		...
		// Math error checking enabled.
			for (x = 0; x < arraylen; x++) {
				if ( loop_willoverflow_unsigned_long(param, data2[x]) ) {return ARR_ERR_OVFL;}
				data2[x] = param - data2[x];
			}
		}
...
// param_num_arr_arr
signed int sub_unsigned_long_4(Py_ssize_t arraylen, unsigned long param, unsigned long *data2, unsigned long *data3, unsigned int ignoreerrors) {
...
// param_arr_arr_none
signed int sub_unsigned_long_5(Py_ssize_t arraylen, unsigned long *data1, unsigned long *data2, unsigned int ignoreerrors) {
	...
	Py_ssize_t x;
		...
		// Math error checking enabled.
			for (x = 0; x < arraylen; x++) {
				if ( loop_willoverflow_unsigned_long(data1[x], data2[x]) ) {return ARR_ERR_OVFL;}
				data1[x] = data1[x] - data2[x];
			}
		}
...
// param_arr_arr_arr
signed int sub_unsigned_long_6(Py_ssize_t arraylen, unsigned long *data1, unsigned long *data2, unsigned long *data3, unsigned int ignoreerrors) {
...
*/
// param_arr_num_none
signed int sub_signed_long_long_1(Py_ssize_t arraylen, signed long long *data1, signed long long param, unsigned int ignoreerrors) {
	...
	signed long long ovlimit;
		...
		// Math error checking enabled.
			...
			if (param > 0) {
				ovlimit = pos_ovlimit_12_signed_long_long(param);
				for (x = 0; x < arraylen; x++) {
					if ( pos_willoverflow(data1[x], ovlimit) ) {return ARR_ERR_OVFL;}
					data1[x] = data1[x] - param; 
				}
			...
			if (param < 0) {
				ovlimit = neg_ovlimit_12_signed_long_long(param);
				for (x = 0; x < arraylen; x++) {
					if ( neg_willoverflow(data1[x], ovlimit) ) {return ARR_ERR_OVFL;}
					data1[x] = data1[x] - param; 
				}
...
// param_arr_num_arr
signed int sub_signed_long_long_2(Py_ssize_t arraylen, signed long long *data1, signed long long param, signed long long *data3, unsigned int ignoreerrors) {
...
// param_num_arr_none
signed int sub_signed_long_long_3(Py_ssize_t arraylen, signed long long param, signed long long *data2, unsigned int ignoreerrors) {
	...
	signed long long ovlimit;
		...
		// Math error checking enabled.
			...
			if (param > 0) {
				ovlimit = pos_ovlimit_34_signed_long_long(param);
				for (x = 0; x < arraylen; x++) {
					if ( pos_willoverflow(data2[x], ovlimit) ) {return ARR_ERR_OVFL;}
					data2[x] = param - data2[x]; 
				}
			...
			if (param < 0) {
				ovlimit = neg_ovlimit_34_signed_long_long(param);
				for (x = 0; x < arraylen; x++) {
					if ( neg_willoverflow(data2[x], ovlimit) ) {return ARR_ERR_OVFL;}
					data2[x] = param - data2[x]; 
				}
...
// param_num_arr_arr
signed int sub_signed_long_long_4(Py_ssize_t arraylen, signed long long param, signed long long *data2, signed long long *data3, unsigned int ignoreerrors) {
...
// param_arr_arr_none
signed int sub_signed_long_long_5(Py_ssize_t arraylen, signed long long *data1, signed long long *data2, unsigned int ignoreerrors) {
...
// param_arr_arr_arr
signed int sub_signed_long_long_6(Py_ssize_t arraylen, signed long long *data1, signed long long *data2, signed long long *data3, unsigned int ignoreerrors) {
...
*/
// param_arr_num_none
signed int sub_unsigned_long_long_1(Py_ssize_t arraylen, unsigned long long *data1, unsigned long long param, unsigned int ignoreerrors) {
	...
	Py_ssize_t x;
		...
		// Math error checking enabled.
			for (x = 0; x < arraylen; x++) {
				if ( loop_willoverflow_unsigned_long_long(data1[x], param) ) {return ARR_ERR_OVFL;}
				data1[x] = data1[x] - param;
			}
		}
...
// param_arr_num_arr
signed int sub_unsigned_long_long_2(Py_ssize_t arraylen, unsigned long long *data1, unsigned long long param, unsigned long long *data3, unsigned int ignoreerrors) {
...
// param_num_arr_none
signed int sub_unsigned_long_long_3(Py_ssize_t arraylen, unsigned long long param, unsigned long long *data2, unsigned int ignoreerrors) {
	...
	Py_ssize_t x;
		...
		// Math error checking enabled.
			for (x = 0; x < arraylen; x++) {
				if ( loop_willoverflow_unsigned_long_long(param, data2[x]) ) {return ARR_ERR_OVFL;}
				data2[x] = param - data2[x];
			}
		}
...
// param_num_arr_arr
signed int sub_unsigned_long_long_4(Py_ssize_t arraylen, unsigned long long param, unsigned long long *data2, unsigned long long *data3, unsigned int ignoreerrors) {
...
// param_arr_arr_none
signed int sub_unsigned_long_long_5(Py_ssize_t arraylen, unsigned long long *data1, unsigned long long *data2, unsigned int ignoreerrors) {
	...
	Py_ssize_t x;
		...
		// Math error checking enabled.
			for (x = 0; x < arraylen; x++) {
				if ( loop_willoverflow_unsigned_long_long(data1[x], data2[x]) ) {return ARR_ERR_OVFL;}
				data1[x] = data1[x] - data2[x];
			}
		}
...
// param_arr_arr_arr
signed int sub_unsigned_long_long_6(Py_ssize_t arraylen, unsigned long long *data1, unsigned long long *data2, unsigned long long *data3, unsigned int ignoreerrors) {
...
signed int sub_float_1(Py_ssize_t arraylen, int nosimd, float *data1, float param, unsigned int ignoreerrors) {
	...
	if (!nosimd && enoughforsimd(arraylen, FLOATSIMDSIZE)) {
		...
		if (ignoreerrors) {
			...
			errorstate = sub_float_1_simd_ovfl(arraylen, data1, param);
...
signed int sub_float_2(Py_ssize_t arraylen, int nosimd, float *data1, float param, float *data3, unsigned int ignoreerrors) {
	...
	if (!nosimd && enoughforsimd(arraylen, FLOATSIMDSIZE)) {
		...
		if (ignoreerrors) {
			...
			errorstate = sub_float_2_simd_ovfl(arraylen, data1, param, data3);
			if (errorstate) {return ARR_ERR_ARITHMETIC;}
		}
...
signed int sub_float_3(Py_ssize_t arraylen, int nosimd, float param, float *data2, unsigned int ignoreerrors) {
	...
	if (!nosimd && enoughforsimd(arraylen, FLOATSIMDSIZE)) {
		...
		if (ignoreerrors) {
			...
			errorstate = sub_float_3_simd_ovfl(arraylen, param, data2);
			if (errorstate) {return ARR_ERR_ARITHMETIC;}
		}
...
signed int sub_float_4(Py_ssize_t arraylen, int nosimd, float param, float *data2, float *data3, unsigned int ignoreerrors) {
	...
	if (!nosimd && enoughforsimd(arraylen, FLOATSIMDSIZE)) {
		...
		if (ignoreerrors) {
			...
			errorstate = sub_float_4_simd_ovfl(arraylen, param, data2, data3);
			if (errorstate) {return ARR_ERR_ARITHMETIC;}
		}
...
signed int sub_float_5(Py_ssize_t arraylen, int nosimd, float *data1, float *data2, unsigned int ignoreerrors) {
	...
	if (!nosimd && enoughforsimd(arraylen, FLOATSIMDSIZE)) {
		...
		if (ignoreerrors) {
			...
			errorstate = sub_float_5_simd_ovfl(arraylen, data1, data2);
			if (errorstate) {return ARR_ERR_ARITHMETIC;}
		}
...
signed int sub_float_6(Py_ssize_t arraylen, int nosimd, float *data1, float *data2, float *data3, unsigned int ignoreerrors) {
	...
	if (!nosimd && enoughforsimd(arraylen, FLOATSIMDSIZE)) {
		...
		if (ignoreerrors) {
			...
			errorstate = sub_float_6_simd_ovfl(arraylen, data1, data2, data3);
			if (errorstate) {return ARR_ERR_ARITHMETIC;}
		}
...
signed int sub_double_1(Py_ssize_t arraylen, int nosimd, double *data1, double param, unsigned int ignoreerrors) {
	...
	if (!nosimd && enoughforsimd(arraylen, DOUBLESIMDSIZE)) {
		...
		if (ignoreerrors) {
			...
			errorstate = sub_double_1_simd_ovfl(arraylen, data1, param);
			if (errorstate) {return ARR_ERR_ARITHMETIC;}
		}
...
signed int sub_double_2(Py_ssize_t arraylen, int nosimd, double *data1, double param, double *data3, unsigned int ignoreerrors) {
	...
	if (!nosimd && enoughforsimd(arraylen, DOUBLESIMDSIZE)) {
		...
		if (ignoreerrors) {
			...
			errorstate = sub_double_2_simd_ovfl(arraylen, data1, param, data3);
			if (errorstate) {return ARR_ERR_ARITHMETIC;}
		}
...
signed int sub_double_3(Py_ssize_t arraylen, int nosimd, double param, double *data2, unsigned int ignoreerrors) {
	...
	if (!nosimd && enoughforsimd(arraylen, DOUBLESIMDSIZE)) {
		...
		if (ignoreerrors) {
			...
			errorstate = sub_double_3_simd_ovfl(arraylen, param, data2);
			if (errorstate) {return ARR_ERR_ARITHMETIC;}
		}
...
signed int sub_double_4(Py_ssize_t arraylen, int nosimd, double param, double *data2, double *data3, unsigned int ignoreerrors) {
	...
	if (!nosimd && enoughforsimd(arraylen, DOUBLESIMDSIZE)) {
		...
		if (ignoreerrors) {
			...
			errorstate = sub_double_4_simd_ovfl(arraylen, param, data2, data3);
			if (errorstate) {return ARR_ERR_ARITHMETIC;}
		}
...
signed int sub_double_5(Py_ssize_t arraylen, int nosimd, double *data1, double *data2, unsigned int ignoreerrors) {
	...
	if (!nosimd && enoughforsimd(arraylen, DOUBLESIMDSIZE)) {
		...
		if (ignoreerrors) {
			...
			errorstate = sub_double_5_simd_ovfl(arraylen, data1, data2);
			if (errorstate) {return ARR_ERR_ARITHMETIC;}
		}
...
signed int sub_double_6(Py_ssize_t arraylen, int nosimd, double *data1, double *data2, double *data3, unsigned int ignoreerrors) {
	...
	if (!nosimd && enoughforsimd(arraylen, DOUBLESIMDSIZE)) {
		...
		if (ignoreerrors) {
			...
			errorstate = sub_double_6_simd_ovfl(arraylen, data1, data2, data3);
			if (errorstate) {return ARR_ERR_ARITHMETIC;}
		}
...
static PyObject *py_sub(PyObject *self, PyObject *args, PyObject *keywds) {
	...
	switch(arraydata.arraytype) {
		...
		case 'l' : {
			switch (arraydata.paramcat) {
				case param_arr_num_none : {
					resultcode = sub_signed_long_1(arraydata.arraylength, arraydata.array1.l, arraydata.param.l, arraydata.ignoreerrors);
					break;
				}
				case param_arr_num_arr : {
					resultcode = sub_signed_long_2(arraydata.arraylength, arraydata.array1.l, arraydata.param.l, arraydata.array3.l, arraydata.ignoreerrors);
					break;
				}
				case param_num_arr_none : {
					resultcode = sub_signed_long_3(arraydata.arraylength, arraydata.param.l, arraydata.array2.l, arraydata.ignoreerrors);
					break;
				}
				case param_num_arr_arr : {
					resultcode = sub_signed_long_4(arraydata.arraylength, arraydata.param.l, arraydata.array2.l, arraydata.array3.l, arraydata.ignoreerrors);
					break;
				}
				case param_arr_arr_none : {
					resultcode = sub_signed_long_5(arraydata.arraylength, arraydata.array1.l, arraydata.array2.l, arraydata.ignoreerrors);
					break;
				}
				case param_arr_arr_arr : {
					resultcode = sub_signed_long_6(arraydata.arraylength, arraydata.array1.l, arraydata.array2.l, arraydata.array3.l, arraydata.ignoreerrors);
					break;
				}
			}
			break;
		...
		case 'L' : {
			switch (arraydata.paramcat) {
				case param_arr_num_none : {
					resultcode = sub_unsigned_long_1(arraydata.arraylength, arraydata.array1.L, arraydata.param.L, arraydata.ignoreerrors);
					break;
				}
				case param_arr_num_arr : {
					resultcode = sub_unsigned_long_2(arraydata.arraylength, arraydata.array1.L, arraydata.param.L, arraydata.array3.L, arraydata.ignoreerrors);
					break;
				}
				case param_num_arr_none : {
					resultcode = sub_unsigned_long_3(arraydata.arraylength, arraydata.param.L, arraydata.array2.L, arraydata.ignoreerrors);
					break;
				}
				case param_num_arr_arr : {
					resultcode = sub_unsigned_long_4(arraydata.arraylength, arraydata.param.L, arraydata.array2.L, arraydata.array3.L, arraydata.ignoreerrors);
					break;
				}
				case param_arr_arr_none : {
					resultcode = sub_unsigned_long_5(arraydata.arraylength, arraydata.array1.L, arraydata.array2.L, arraydata.ignoreerrors);
					break;
				}
				case param_arr_arr_arr : {
					resultcode = sub_unsigned_long_6(arraydata.arraylength, arraydata.array1.L, arraydata.array2.L, arraydata.array3.L, arraydata.ignoreerrors);
					break;
				}
			}
			break;
		...
		case 'q' : {
			switch (arraydata.paramcat) {
				case param_arr_num_none : {
					resultcode = sub_signed_long_long_1(arraydata.arraylength, arraydata.array1.q, arraydata.param.q, arraydata.ignoreerrors);
					break;
				}
				case param_arr_num_arr : {
					resultcode = sub_signed_long_long_2(arraydata.arraylength, arraydata.array1.q, arraydata.param.q, arraydata.array3.q, arraydata.ignoreerrors);
					break;
				}
				case param_num_arr_none : {
					resultcode = sub_signed_long_long_3(arraydata.arraylength, arraydata.param.q, arraydata.array2.q, arraydata.ignoreerrors);
					break;
				}
				case param_num_arr_arr : {
					resultcode = sub_signed_long_long_4(arraydata.arraylength, arraydata.param.q, arraydata.array2.q, arraydata.array3.q, arraydata.ignoreerrors);
					break;
				}
				case param_arr_arr_none : {
					resultcode = sub_signed_long_long_5(arraydata.arraylength, arraydata.array1.q, arraydata.array2.q, arraydata.ignoreerrors);
					break;
				}
				case param_arr_arr_arr : {
					resultcode = sub_signed_long_long_6(arraydata.arraylength, arraydata.array1.q, arraydata.array2.q, arraydata.array3.q, arraydata.ignoreerrors);
					break;
				}
			}
			break;
		...
		case 'Q' : {
			switch (arraydata.paramcat) {
				case param_arr_num_none : {
					resultcode = sub_unsigned_long_long_1(arraydata.arraylength, arraydata.array1.Q, arraydata.param.Q, arraydata.ignoreerrors);
					break;
				}
				case param_arr_num_arr : {
					resultcode = sub_unsigned_long_long_2(arraydata.arraylength, arraydata.array1.Q, arraydata.param.Q, arraydata.array3.Q, arraydata.ignoreerrors);
					break;
				}
				case param_num_arr_none : {
					resultcode = sub_unsigned_long_long_3(arraydata.arraylength, arraydata.param.Q, arraydata.array2.Q, arraydata.ignoreerrors);
					break;
				}
				case param_num_arr_arr : {
					resultcode = sub_unsigned_long_long_4(arraydata.arraylength, arraydata.param.Q, arraydata.array2.Q, arraydata.array3.Q, arraydata.ignoreerrors);
					break;
				}
				case param_arr_arr_none : {
					resultcode = sub_unsigned_long_long_5(arraydata.arraylength, arraydata.array1.Q, arraydata.array2.Q, arraydata.ignoreerrors);
					break;
				}
				case param_arr_arr_arr : {
					resultcode = sub_unsigned_long_long_6(arraydata.arraylength, arraydata.array1.Q, arraydata.array2.Q, arraydata.array3.Q, arraydata.ignoreerrors);
					break;
				}
			}
			break;
...
/* A list of all the methods defined by this module. 
 "sub" is the name seen inside of Python. 
 "py_sub" is the name of the C function handling the Python call. 
 "METH_VARGS" tells Python how to call the handler. 
 The {NULL, NULL} entry indicates the end of the method definitions. */
static PyMethodDef sub_methods[] = {
	{"sub",  (PyCFunction)py_sub, METH_VARARGS | METH_KEYWORDS, sub__doc__}, 
	{NULL, NULL, 0, NULL}
};


static struct PyModuleDef submodule = {
...
{
    return PyModule_Create(&submodule);
};

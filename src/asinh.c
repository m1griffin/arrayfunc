...
// Project:  arrayfunc
// Module:   asinh.c
// Purpose:  Calculate the asinh of values in an array.
// Language: C
// Date:     15-Nov-2017.
//
//------------------------------------------------------------------------------
...
static PyObject *py_asinh(PyObject *self, PyObject *args, PyObject *keywds) {
...
/* A list of all the methods defined by this module. 
 "asinh" is the name seen inside of Python. 
 "py_asinh" is the name of the C function handling the Python call. 
 "METH_VARGS" tells Python how to call the handler. 
 The {NULL, NULL} entry indicates the end of the method definitions. */
static PyMethodDef asinh_methods[] = {
	{"asinh",  (PyCFunction)py_asinh, METH_VARARGS | METH_KEYWORDS, asinh__doc__}, 
	{NULL, NULL, 0, NULL}
};


static struct PyModuleDef asinhmodule = {
...
PyMODINIT_FUNC PyInit_asinh(void)
{
    return PyModule_Create(&asinhmodule);
};

...
void trunc_float_1_simd(Py_ssize_t arraylen, float *data) {
	...
	for (x = 0; x < alignedlength; x += FLOATSIMDSIZE) {
		...
		datasliceleft = __builtin_ia32_roundps (datasliceleft, 0b11);
		// Store the result.
...
// param_arr_none
#if defined(AF_HASSIMD_X86)
char trunc_float_1_simd_ovfl(Py_ssize_t arraylen, float *data) {
...
// param_arr_arr
char trunc_float_2_simd_ovfl(Py_ssize_t arraylen, float *data, float *dataout) {
...
void trunc_double_1_simd(Py_ssize_t arraylen, double *data) {
	...
	for (x = 0; x < alignedlength; x += DOUBLESIMDSIZE) {
		...
		// The actual SIMD operation. 
		datasliceleft = __builtin_ia32_roundpd (datasliceleft, 0b11);
		// Store the result.
...
// param_arr_none
#if defined(AF_HASSIMD_X86)
char trunc_double_1_simd_ovfl(Py_ssize_t arraylen, double *data) {
...
// param_arr_arr
char trunc_double_2_simd_ovfl(Py_ssize_t arraylen, double *data, double *dataout) {

...
*/
signed int gamma_float(Py_ssize_t arraylen, float *data, float *dataout, unsigned int ignoreerrors, bool hassecondarray) {
...
/* arraylen = The length of the data arrays.
   ...
   hassecondarray = If true, the output goes into the second array.
*/
signed int gamma_double(Py_ssize_t arraylen, double *data, double *dataout, unsigned int ignoreerrors, bool hassecondarray) {
...
static PyObject *py_gamma(PyObject *self, PyObject *args, PyObject *keywds) {
	...
	arraydata = getparams_one(self, args, keywds, "gamma");
	...
	switch(arraydata.arraytype) {
		// float
		case 'f' : {
			resultcode = gamma_float(arraydata.arraylength, arraydata.array1.f, arraydata.array2.f, arraydata.ignoreerrors, arraydata.hassecondarray);
			break;
		}
		// double
		case 'd' : {
			resultcode = gamma_double(arraydata.arraylength, arraydata.array1.d, arraydata.array2.d, arraydata.ignoreerrors, arraydata.hassecondarray);
			break;
		}

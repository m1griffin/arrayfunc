...
int8x8_t initvec_armshift_signed_char(signed char initval) {
...
*/
#if defined(AF_HASSIMD_ARMv7_32BIT)
int8x8_t initvec_armshift_unsigned_char(unsigned char initval) {
...
*/
#if defined(AF_HASSIMD_ARMv7_32BIT)
int16x4_t initvec_armshift_signed_short(signed short initval) {
...
*/
#if defined(AF_HASSIMD_ARMv7_32BIT)
int16x4_t initvec_armshift_unsigned_short(unsigned short initval) {
...
*/
#if defined(AF_HASSIMD_ARMv7_32BIT)
int32x2_t initvec_armshift_signed_int(signed int initval) {
...
*/
#if defined(AF_HASSIMD_ARMv7_32BIT)
int32x2_t initvec_armshift_unsigned_int(unsigned int initval) {

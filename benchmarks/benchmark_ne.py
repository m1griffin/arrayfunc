...
def InitOptionData(arraycode, arraysize, funcname):
	...
	if funcname == 'ldexp':
		ydata = [6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6]
...
HasMathErrorOption = 'matherrors' in "result = arrayfunc.ne(datax, yvalue, nosimd=True)"

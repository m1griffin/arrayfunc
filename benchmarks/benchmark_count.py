	...
	if False:
		for x in range(pyitercounts):
			for i in range(arraylength):
				result = pycount(arraycode, pyitercounts, datax, arraysize)
	else:
		for x in range(pyitercounts):
			result = pycount(arraycode, pyitercounts, datax, arraysize)
...
HasMathErrorOption = 'matherrors' in "arrayfunc.count(datax, compval)"

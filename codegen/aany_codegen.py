...
simdfilename = 'aany_simd_x86'

maindescription = 'Returns True if any elements in an array meet the selected criteria.'
...
# Generate the code for the standard platform independent C code.

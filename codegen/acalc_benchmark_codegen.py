...
with open('acalcbenchmarkdata.txt', 'w') as f:
...
with open('acalcbenchmarkplatform.txt', 'w') as f:
...
with open('acalcbenchmark.py', 'w') as f:
	...
	headerdate = codegen_common.FormatHeaderData('acalc_benchmark', '05-Feb-2016', '')

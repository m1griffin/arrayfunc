...
# The basic class template for testing math constants.
mathconst_template = '''
##############################################################################
class acalcvm_mathconst_%(typelabel)s(unittest.TestCase):
	"""Test math constants.
	"""
	...
	def setUp(self):
		...
		self.data = array.array('%(typecode)s', [1, 2, 3, 4, 5] * 10)
		self.dataout = array.array('%(typecode)s', [0]*len(self.data))
	...
	########################################################
	def test_math_pi_%(typelabel)s_acalcvm(self):
		"""Test acalcvm for math constants - math.pi - Array code %(typelabel)s.
		"""
	...
	########################################################
	def test_math_e_%(typelabel)s_acalcvm(self):
		"""Test acalcvm for math constants - math.e - Array code %(typelabel)s.
		"""
...
with open('test_acalcvm.py', 'w') as f:
	...
	for arraycode in codegen_common.floatarrays:
		'typelabel', 'typecode'
		f.write(mathconst_template % {'typelabel' : arraycode, 'typecode' : arraycode})

...
class amin_operator_b(unittest.TestCase):
	...
	def test_function_13(self):
		"""Test amin  - Array code b. Test invalid parameter type with SIMD.
		"""
	...
	def test_function_14(self):
		"""Test amin  - Array code b. Test invalid parameter type without SIMD.
		"""
		with self.assertRaises(TypeError):
...
class amin_operator_h(unittest.TestCase):
	...
	########################################################
	def test_function_13(self):
		"""Test amin  - Array code h. Test invalid parameter type with SIMD.
		"""
		with self.assertRaises(TypeError):
			result = arrayfunc.amin(1)
	...
	########################################################
	def test_function_14(self):
		"""Test amin  - Array code h. Test invalid parameter type without SIMD.
		"""
		with self.assertRaises(TypeError):
			result = arrayfunc.amin(1, nosimd=True)
...
class amin_operator_i(unittest.TestCase):
	...
	########################################################
	def test_function_13(self):
		"""Test amin  - Array code i. Test invalid parameter type with SIMD.
		"""
		with self.assertRaises(TypeError):
			result = arrayfunc.amin(1)
	...
	########################################################
	def test_function_14(self):
		"""Test amin  - Array code i. Test invalid parameter type without SIMD.
		"""
		with self.assertRaises(TypeError):
			result = arrayfunc.amin(1, nosimd=True)
...
class amin_operator_l(unittest.TestCase):
	...
	########################################################
	def test_function_13(self):
		"""Test amin  - Array code l. Test invalid parameter type with SIMD.
		"""
		with self.assertRaises(TypeError):
			result = arrayfunc.amin(1)
	...
	########################################################
	def test_function_14(self):
		"""Test amin  - Array code l. Test invalid parameter type without SIMD.
		"""
		with self.assertRaises(TypeError):
			result = arrayfunc.amin(1, nosimd=True)
...
class amin_operator_q(unittest.TestCase):
	...
	########################################################
	def test_function_13(self):
		"""Test amin  - Array code q. Test invalid parameter type with SIMD.
		"""
		with self.assertRaises(TypeError):
			result = arrayfunc.amin(1)
	...
	########################################################
	def test_function_14(self):
		"""Test amin  - Array code q. Test invalid parameter type without SIMD.
		"""
		with self.assertRaises(TypeError):
			result = arrayfunc.amin(1, nosimd=True)
...
class amin_operator_f(unittest.TestCase):
	...
	########################################################
	def test_function_13(self):
		"""Test amin  - Array code f. Test invalid parameter type with SIMD.
		"""
		with self.assertRaises(TypeError):
			result = arrayfunc.amin(1)
	...
	########################################################
	def test_function_14(self):
		"""Test amin  - Array code f. Test invalid parameter type without SIMD.
		"""
		with self.assertRaises(TypeError):
			result = arrayfunc.amin(1, nosimd=True)
...
class amin_operator_d(unittest.TestCase):
	...
	########################################################
	def test_function_13(self):
		"""Test amin  - Array code d. Test invalid parameter type with SIMD.
		"""
		with self.assertRaises(TypeError):
			result = arrayfunc.amin(1)
	...
	########################################################
	def test_function_14(self):
		"""Test amin  - Array code d. Test invalid parameter type without SIMD.
		"""
		with self.assertRaises(TypeError):
			result = arrayfunc.amin(1, nosimd=True)

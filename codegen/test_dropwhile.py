...
#
##############################################################################
"""This conducts unit tests for dropwhile.
"""
...
class dropwhile_operator_b(unittest.TestCase):
	...
	def test_param_invalid_keyword_params(self):
		...
		"""
		with self.assertRaises(TypeError):
			result = arrayfunc.dropwhile(arrayfunc.aops.af_eq, self.data, self.dataout, int(100), xx=2)
	...
	def test_param_invalid_keyword_param_type(self):
		...
		"""
		with self.assertRaises(TypeError):
			result = arrayfunc.dropwhile(arrayfunc.aops.af_eq, self.data, self.dataout, int(100), maxlen='x')
	...
	def test_param_invalid_opcode_param_value(self):
		...
		with self.assertRaises(ValueError):
			result = arrayfunc.dropwhile(-1, self.data, self.dataout, int(100))
	...
	def test_param_invalid_opcode_param_type(self):
		...
		"""
		with self.assertRaises(TypeError):
			result = arrayfunc.dropwhile('a', self.data, self.dataout, int(100))
	...
	def test_param_invalid_input_array_param_value(self):
		...
		"""
		with self.assertRaises(TypeError):
			result = arrayfunc.dropwhile(arrayfunc.aops.af_eq, 99, self.dataout, int(100))
	...
	def test_param_invalid_output_array_param_value(self):
		...
		"""
		with self.assertRaises(TypeError):
			result = arrayfunc.dropwhile(arrayfunc.aops.af_eq, self.data, 99, int(100))
	...
	def test_param_invalid_input_array_param_length(self):
		...
		with self.assertRaises(IndexError):
			result = arrayfunc.dropwhile(arrayfunc.aops.af_eq, self.dataempty, self.dataout, int(100))
	...
	def test_param_invalid_output_array_param_length(self):
		...
		"""
		with self.assertRaises(IndexError):
			result = arrayfunc.dropwhile(arrayfunc.aops.af_eq, self.data, self.dataempty, int(100))
	...
	def test_param_invalid_array_param_type_02(self):
		...
		"""
		with self.assertRaises(TypeError):
			result = arrayfunc.dropwhile(arrayfunc.aops.af_eq, self.data, self.dataout, float(100.5))
	...
	def test_overflow_min(self):
		...
		with self.assertRaises(OverflowError):
			result = arrayfunc.dropwhile(arrayfunc.aops.af_eq, self.dataovfl, self.dataoutovfl, self.MinVal - 1)
	...
	def test_overflow_max(self):
		...
		"""
		with self.assertRaises(OverflowError):
			result = arrayfunc.dropwhile(arrayfunc.aops.af_eq, self.dataovfl, self.dataoutovfl, self.Maxval + 1)
...
class dropwhile_operator_f(unittest.TestCase):
	...
	def test_param_invalid_keyword_params(self):
		...
		"""
		with self.assertRaises(TypeError):
			result = arrayfunc.dropwhile(arrayfunc.aops.af_eq, self.data, self.dataout, float(100), xx=2)
	...
	def test_param_invalid_keyword_param_type(self):
		...
		"""
		with self.assertRaises(TypeError):
			result = arrayfunc.dropwhile(arrayfunc.aops.af_eq, self.data, self.dataout, float(100), maxlen='x')
	...
	def test_param_invalid_opcode_param_value(self):
		...
		"""
		with self.assertRaises(ValueError):
			result = arrayfunc.dropwhile(-1, self.data, self.dataout, float(100))
	...
	def test_param_invalid_opcode_param_type(self):
		...
		"""
		with self.assertRaises(TypeError):
			result = arrayfunc.dropwhile('a', self.data, self.dataout, float(100))
	...
	def test_param_invalid_input_array_param_value(self):
		...
		"""
		with self.assertRaises(TypeError):
			result = arrayfunc.dropwhile(arrayfunc.aops.af_eq, 99, self.dataout, float(100))
	...
	def test_param_invalid_output_array_param_value(self):
		...
		"""
		with self.assertRaises(TypeError):
			result = arrayfunc.dropwhile(arrayfunc.aops.af_eq, self.data, 99, float(100))
	...
	def test_param_invalid_input_array_param_length(self):
		...
		"""
		with self.assertRaises(IndexError):
			result = arrayfunc.dropwhile(arrayfunc.aops.af_eq, self.dataempty, self.dataout, float(100))
	...
	def test_param_invalid_output_array_param_length(self):
		...
		"""
		with self.assertRaises(IndexError):
			result = arrayfunc.dropwhile(arrayfunc.aops.af_eq, self.data, self.dataempty, float(100))
	...
	def test_param_invalid_array_param_type_02(self):
		...
		"""
		with self.assertRaises(TypeError):
			result = arrayfunc.dropwhile(arrayfunc.aops.af_eq, self.data, self.dataout, int(100.5))
	...
	def test_overflow_min(self):
		...
		"""
		with self.assertRaises(OverflowError):
			result = arrayfunc.dropwhile(arrayfunc.aops.af_eq, self.dataovfl, self.dataoutovfl, self.MinVal * 1.1)
	...
	def test_overflow_max(self):
		...
		"""
		with self.assertRaises(OverflowError):
			result = arrayfunc.dropwhile(arrayfunc.aops.af_eq, self.dataovfl, self.dataoutovfl, self.Maxval * 1.1)
...
##############################################################################
class dropwhile_operator_bytes(unittest.TestCase):
	"""Test for basic operator function.
	"""
	...
	########################################################
	def test_param_invalid_input_array_param_value(self):
		"""Test exception with invalid array input parameter value  - Array code bytes.
		"""
		with self.assertRaises(TypeError):
			result = arrayfunc.dropwhile(arrayfunc.aops.af_eq, 99, self.dataout, int(100))
